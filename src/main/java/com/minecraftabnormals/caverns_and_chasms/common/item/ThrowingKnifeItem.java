...
import com.minecraftabnormals.caverns_and_chasms.common.entity.ThrowingKnifeEntity;
...
public class ThrowingKnifeItem extends EggItem {

	public ThrowingKnifeItem(Properties builder) {
		super(builder);
	}
