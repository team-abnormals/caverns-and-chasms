...
public class FlyEntity extends CreatureEntity implements IFlyingAnimal {
	...
	class WanderGoal extends Goal {
		...
		public boolean shouldExecute() {
			return FlyEntity.this.navigator.noPath() && FlyEntity.this.rand.nextInt(10) == 0;
		}
		...
		public void startExecuting() {
			...
			if (vec3d != null) {
				FlyEntity.this.navigator.setPath(FlyEntity.this.navigator.getPathToPos(new BlockPos(vec3d), 1), 1.0D);
			}
		}
		...
		private Vector3d func_226509_g_() {
			...
			Vector3d vec3d2 = RandomPositionGenerator.findAirTarget(FlyEntity.this, 8, 7, vec3d, ((float) Math.PI / 2F), 2, 1);
