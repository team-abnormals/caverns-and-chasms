...
public class CCItems {
	...
	public static final RegistryObject<Item> THROWING_KNIFE = HELPER.createItem("throwing_knife", () -> new ThrowingKnifeItem(new Item.Properties().group(ItemGroup.COMBAT)));
