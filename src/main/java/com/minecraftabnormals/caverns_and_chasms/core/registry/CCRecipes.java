...
public class CCRecipes {
	...
	public static class Serailizers {
		...
		public static final RegistryObject<RecipeSerializer<MimingRecipe>> MIMING = RECIPE_SERIALIZERS.register("miming", () -> new SingleItemRecipe.Serializer<MimingRecipe>(MimingRecipe::new) {});
	}
