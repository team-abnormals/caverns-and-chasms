package com.minecraftabnormals.cave_upgrade.client;
...
public class DeeperSpriteUploader extends SpriteUploader {
	public static final ResourceLocation ATLAS_LOCATION = new ResourceLocation(CaveUpgrade.MODID, "textures/atlas/deeper.png");
	public static final ResourceLocation DEEPER_SPRITE = new ResourceLocation(CaveUpgrade.MODID, "deeper");
	public static final ResourceLocation EMISSIVE_SPRITE = new ResourceLocation(CaveUpgrade.MODID, "deeper_emissive");
