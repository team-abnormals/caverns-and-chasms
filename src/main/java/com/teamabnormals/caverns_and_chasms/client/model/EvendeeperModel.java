...
public class EvendeeperModel extends DeeperModel<Evendeeper> {
	...
	public static LayerDefinition createBodyLayer(CubeDeformation deformation, boolean includeHat) {
		...
		root.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(16, 36).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 4.0F, 4.0F, deformation), PartPose.offset(-2.0F, 20.0F, 2.0F));
		root.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 34).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 6.0F, 4.0F, deformation), PartPose.offset(2.0F, 18.0F, 2.0F));
		root.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(0, 34).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 6.0F, 4.0F, deformation), PartPose.offset(-2.0F, 18.0F, -2.0F));
		root.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(16, 36).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 4.0F, 4.0F, deformation), PartPose.offset(2.0F, 20.0F, -2.0F));
