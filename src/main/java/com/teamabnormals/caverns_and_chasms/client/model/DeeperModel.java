...
public class DeeperModel<T extends Deeper> extends ListModel<T> {
	...
	public static LayerDefinition createBodyLayer(CubeDeformation deformation, boolean includeHat) {
		...
		root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, -18.0F, -2.0F, 8.0F, 12.0F, 4.0F, deformation).texOffs(40, 16).addBox(-4.0F, -18.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 0.0F, 0.0F));
		root.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, deformation), PartPose.offset(-2.0F, 18.0F, 4.0F));
		root.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(0, 26).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, deformation), PartPose.offset(2.0F, 18.0F, 4.0F));
		root.addOrReplaceChild("leg3", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, deformation), PartPose.offset(-2.0F, 18.0F, -4.0F));
		root.addOrReplaceChild("leg4", CubeListBuilder.create().texOffs(0, 26).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, deformation), PartPose.offset(2.0F, 18.0F, -4.0F));
	...
	protected TextureAtlasSprite getTextureAtlasSprite(DeeperSprite deeperSprite) {
		return DeeperSpriteUploader.getSprite(deeperSprite);
	}

	protected ResourceLocation getTextureAtlasLocation() {
		return DeeperSpriteUploader.ATLAS_LOCATION;
	}
	...
	@Override
	public void setupAnim(T deeper, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
