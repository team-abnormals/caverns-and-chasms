...
public class GlareModel<T extends Glare> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-6.0F, -13.0F, -6.0F, 12.0F, 13.0F, 12.0F, CubeDeformation.NONE)
				.texOffs(24, 0).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 0.01F, 12.0F, CubeDeformation.NONE)
				.texOffs(24, 0).addBox(-6.0F, -11.0F, -6.0F, 12.0F, 0.01F, 12.0F, CubeDeformation.NONE)
				.texOffs(24, 42).addBox(-5.0F, -12.0F, -1.0F, 10.0F, 10.0F, 6.0F, new CubeDeformation(0.5F)),
				PartPose.offset(0.0F, 20.0F, 0.0F));

		PartDefinition bottom = partdefinition.addOrReplaceChild("bottom", CubeListBuilder.create()
				.texOffs(0, 25).addBox(-5.0F, 1.0F, -5.0F, 10.0F, 7.0F, 10.0F, CubeDeformation.NONE)
				.texOffs(17, 1).addBox(-5.0F, 3.9F, -5.0F, 10.0F, 0.0F, 10.0F, CubeDeformation.NONE)
				.texOffs(0, 42).addBox(-3.0F, 4.0F, -3.0F, 6.0F, 8.0F, 6.0F, CubeDeformation.NONE),
