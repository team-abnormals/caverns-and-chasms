...
public class UndeadRatRenderer extends RatRenderer {
	private static final ResourceLocation ZOMBIE_RAT_TEXTURE = CavernsAndChasms.location("textures/entity/rat/zombie_rat.png");
	private static final ResourceLocation SKELETON_RAT_TEXTURE = CavernsAndChasms.location("textures/entity/rat/skeleton_rat.png");
