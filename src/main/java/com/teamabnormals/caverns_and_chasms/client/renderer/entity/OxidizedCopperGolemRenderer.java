...
public class OxidizedCopperGolemRenderer extends LivingEntityRenderer<OxidizedCopperGolem, CopperGolemModel<OxidizedCopperGolem>> {
	private static final ResourceLocation OXIDIZED_GOLEM_TEXTURE = CavernsAndChasms.location("textures/entity/copper_golem/copper_golem_oxidized.png");
	private static final ResourceLocation DAMAGED_OXIDIZED_GOLEM_TEXTURE = CavernsAndChasms.location("textures/entity/copper_golem/copper_golem_oxidized_damaged.png");
