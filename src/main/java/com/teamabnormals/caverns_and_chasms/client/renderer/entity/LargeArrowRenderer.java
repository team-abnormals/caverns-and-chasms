...
public class LargeArrowRenderer extends EntityRenderer<LargeArrow> {
	...
	public void render(LargeArrow entity, float p_113840_, float p_113841_, PoseStack poseStack, MultiBufferSource buffer, int p_113844_) {
		poseStack.pushPose();
		poseStack.mulPose(Vector3f.YP.rotationDegrees(Mth.lerp(p_113841_, entity.yRotO, entity.getYRot()) - 90.0F));
		poseStack.mulPose(Vector3f.ZP.rotationDegrees(Mth.lerp(p_113841_, entity.xRotO, entity.getXRot())));
