...
public class FireworkScattererBehavior extends DefaultDispenseItemBehavior {
	...
	public ItemStack execute(BlockSource source, ItemStack stack) {
		...
		FireworkRocketEntity fireworkrocketentity = new FireworkRocketEntity(level, stack, source.x(), source.y(), source.x(), true);
		...
		source.level().addFreshEntity(fireworkrocketentity);
		stack.shrink(1);
		return stack;
	}
