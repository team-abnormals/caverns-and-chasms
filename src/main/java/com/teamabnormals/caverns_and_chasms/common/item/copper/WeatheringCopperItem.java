...
public interface WeatheringCopperItem {
	Supplier<BiMap<Item, Item>> NEXT_BY_ITEM = Suppliers.memoize(() -> ImmutableBiMap.<Item, Item>builder()
			...
			.put(COPPER_HORSE_ARMOR.get(), EXPOSED_COPPER_HORSE_ARMOR.get())
			.put(EXPOSED_COPPER_HORSE_ARMOR.get(), WEATHERED_COPPER_HORSE_ARMOR.get())
			.put(WEATHERED_COPPER_HORSE_ARMOR.get(), OXIDIZED_COPPER_HORSE_ARMOR.get())
