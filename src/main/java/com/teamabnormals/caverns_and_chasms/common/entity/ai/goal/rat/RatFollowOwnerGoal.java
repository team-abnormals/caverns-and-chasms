...
public class RatFollowOwnerGoal extends FollowOwnerGoal {
	...
	public boolean canUse() {
		return !this.rat.isSittingBecauseOrdered() && this.rat.getCommandedPos() == null && super.canUse();
	}

	@Override
	public boolean canContinueToUse() {
		return !this.rat.isSittingBecauseOrdered() && this.rat.getCommandedPos() == null && super.canContinueToUse();
	}
}