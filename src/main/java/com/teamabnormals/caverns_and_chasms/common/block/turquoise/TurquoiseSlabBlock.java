...
public class TurquoiseSlabBlock extends SlabBlock {

	public TurquoiseSlabBlock(Properties properties) {
		super(properties);
	}
	...
	public void stepOn(Level level, BlockPos pos, BlockState state, Entity entity) {
		if (level.isClientSide() && (entity.getDeltaMovement().x > 0 || entity.getDeltaMovement().z > 0)) {
			...
			ParticleUtils.spawnParticlesOnBlockFace(level, pos, CCParticleTypes.TURQUOISE_GREEN_STEP.get(), ConstantInt.of(1), Direction.UP, supplier, 0.05D);
		}
	}
}