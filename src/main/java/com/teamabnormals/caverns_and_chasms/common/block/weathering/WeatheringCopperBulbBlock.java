...
public class WeatheringCopperBulbBlock extends CopperBulbBlock implements CCWeatheringCopper {
	private final WeatherState weatherState;

	public WeatheringCopperBulbBlock(WeatherState weatherState, Properties properties) {
		super(properties);
