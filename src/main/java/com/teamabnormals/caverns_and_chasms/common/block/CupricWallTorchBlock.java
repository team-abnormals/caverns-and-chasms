...
public class CupricWallTorchBlock extends WallTorchBlock {
	...
	public void animateTick(BlockState stateIn, Level worldIn, BlockPos pos, Random rand) {
		...
		worldIn.addParticle(CCParticleTypes.CUPRIC_FIRE_FLAME.get(), d0 + 0.27D * (double) direction1.getStepX(), d1 + 0.22D, d2 + 0.27D * (double) direction1.getStepZ(), 0.0D, 0.0D, 0.0D);
	}
}
