...
public class CCWeatheringCopperWallBlock extends WallBlock implements CCWeatheringCopper {
	private final WeatherState weatherState;

	public CCWeatheringCopperWallBlock(WeatherState weatherState, Properties properties) {
		super(properties);
