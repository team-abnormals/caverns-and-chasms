...
public class WeatheringFloodlightBlock extends FloodlightBlock implements CCWeatheringCopper {

	public WeatheringFloodlightBlock(WeatheringCopper.WeatherState weatherState, Properties properties) {
