...
public interface CCWeatheringCopper extends WeatheringCopper {
	Supplier<BiMap<Block, Block>> NEXT_BY_BLOCK = Suppliers.memoize(() -> HashBiMap.create(ImmutableBiMap.<Block, Block>builder()
			...
			.put(CCBlocks.COPPER_BRICKS.get(), CCBlocks.EXPOSED_COPPER_BRICKS.get())
			.put(CCBlocks.EXPOSED_COPPER_BRICKS.get(), CCBlocks.WEATHERED_COPPER_BRICKS.get())
			.put(CCBlocks.WEATHERED_COPPER_BRICKS.get(), CCBlocks.OXIDIZED_COPPER_BRICKS.get())
			.put(CCBlocks.COPPER_BRICK_STAIRS.get(), CCBlocks.EXPOSED_COPPER_BRICK_STAIRS.get())
			.put(CCBlocks.EXPOSED_COPPER_BRICK_STAIRS.get(), CCBlocks.WEATHERED_COPPER_BRICK_STAIRS.get())
			.put(CCBlocks.WEATHERED_COPPER_BRICK_STAIRS.get(), CCBlocks.OXIDIZED_COPPER_BRICK_STAIRS.get())
			.put(CCBlocks.COPPER_BRICK_SLAB.get(), CCBlocks.EXPOSED_COPPER_BRICK_SLAB.get())
			.put(CCBlocks.EXPOSED_COPPER_BRICK_SLAB.get(), CCBlocks.WEATHERED_COPPER_BRICK_SLAB.get())
			.put(CCBlocks.WEATHERED_COPPER_BRICK_SLAB.get(), CCBlocks.OXIDIZED_COPPER_BRICK_SLAB.get())
			.put(CCBlocks.COPPER_BRICK_WALL.get(), CCBlocks.EXPOSED_COPPER_BRICK_WALL.get())
			.put(CCBlocks.EXPOSED_COPPER_BRICK_WALL.get(), CCBlocks.WEATHERED_COPPER_BRICK_WALL.get())
			.put(CCBlocks.WEATHERED_COPPER_BRICK_WALL.get(), CCBlocks.OXIDIZED_COPPER_BRICK_WALL.get())
