...
public class CCWeatheringCopperStairBlock extends StairBlock implements CCWeatheringCopper {
	private final WeatherState weatherState;

	public CCWeatheringCopperStairBlock(WeatherState weatherState, Supplier<BlockState> state, Properties properties) {
