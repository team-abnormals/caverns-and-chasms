		...
		public void generate(BiConsumer<ResourceLocation, LootTable.Builder> consumer) {
			consumer.accept(FORGE_COMMON, LootTable.lootTable()
					.withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F))
							...
							.add(LootItem.lootTableItem(CCItems.RAW_TIN.get()).setWeight(2))
							.add(LootItem.lootTableItem(CCItems.RAW_SILVER.get()).setWeight(2))
							...
							.add(LootItem.lootTableItem(CCItems.TIN_INGOT.get()).setWeight(2))
							.add(LootItem.lootTableItem(CCItems.SILVER_INGOT.get()).setWeight(2))
							.add(LootItem.lootTableItem(Items.SCAFFOLDING).setWeight(2))
