...
public class CCDataMapProvider extends DataMapProvider {
	...
	protected void gather(Provider provider) {
		...
		this.builder(NeoForgeDataMaps.OXIDIZABLES)
				...
				.add(COPPER_PRESSURE_PLATE, new Oxidizable(EXPOSED_COPPER_PRESSURE_PLATE.get()), false)
				.add(EXPOSED_COPPER_PRESSURE_PLATE, new Oxidizable(WEATHERED_COPPER_PRESSURE_PLATE.get()), false)
				.add(WEATHERED_COPPER_PRESSURE_PLATE, new Oxidizable(OXIDIZED_COPPER_PRESSURE_PLATE.get()), false)
