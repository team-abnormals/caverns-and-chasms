...
public class CCLanguageProvider extends LanguageProvider {
	...
	public void addTranslations() {
		...
		this.add(CCBlocks.SANGUINE_PLATES.get(), CCBlocks.SANGUINE_SLAB.get(), CCBlocks.SANGUINE_STAIRS.get(), CCBlocks.SANGUINE_VERTICAL_SLAB.get());
		this.add(CCBlocks.SPINEL_ORE.get(), CCBlocks.DEEPSLATE_SPINEL_ORE.get());
		this.add(CCBlocks.SPINEL_BRICKS.get(), CCBlocks.SPINEL_BRICK_SLAB.get(), CCBlocks.SPINEL_BRICK_STAIRS.get(), CCBlocks.SPINEL_BRICK_WALL.get(), CCBlocks.SPINEL_BRICK_VERTICAL_SLAB.get(), CCBlocks.SPINEL_PILLAR.get(), CCBlocks.SPINEL_LAMP.get());
		...
		this.add(CCBlocks.LAPIS_LAZULI_BRICKS.get(), CCBlocks.LAPIS_LAZULI_BRICK_SLAB.get(), CCBlocks.LAPIS_LAZULI_BRICK_STAIRS.get(), CCBlocks.LAPIS_LAZULI_BRICK_WALL.get(), CCBlocks.LAPIS_LAZULI_BRICK_VERTICAL_SLAB.get(), CCBlocks.LAPIS_LAZULI_PILLAR.get(), CCBlocks.LAPIS_LAZULI_LAMP.get());
		...
		this.add(CCBlocks.MOSSY_COBBLESTONE_TILES.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_SLAB.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_STAIRS.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_VERTICAL_SLAB.get());
		...
		this.add(CCItems.SPINEL.get(), CCItems.BEJEWELED_PEARL.get(), CCItems.BEJEWELED_APPLE.get(), CCItems.SPINEL_CROWN.get());
		...
		this.add(CCItems.CAVEFISH_SPAWN_EGG.get(), CCItems.DEEPER_SPAWN_EGG.get(), CCItems.MIME_SPAWN_EGG.get(), CCItems.FLY_SPAWN_EGG.get(), CCItems.RAT_SPAWN_EGG.get());
	}
	...
	private void add(Item... items) {
		List.of(items).forEach((item -> this.add(item, format(item.getRegistryName()))));
	}

	private void addStorageBlock(Block... blocks) {
		List.of(blocks).forEach((block -> this.add(block, "Block of " + format(block.getRegistryName()).replace(" Block", ""))));
	}
