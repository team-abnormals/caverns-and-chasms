...
public class CCItemTagsProvider extends BlueprintItemTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(ItemTags.DYEABLE).add(COWL.get(), TOOLBELT.get(), Items.BUNDLE, PACKING_CONTAINER.get(), AEGIS.get(), UNICORN_HORN.get());
		this.tag(CCItemTags.COWL_ENCHANTABLE).add(COWL.get());
		this.tag(CCItemTags.TOOLBELT_ENCHANTABLE).add(TOOLBELT.get());
		this.tag(ItemTags.DURABILITY_ENCHANTABLE).add(AEGIS.get());

		this.copy(CCBlockTags.STANDING_SPARKLERS, CCItemTags.SPARKLERS);
		...
		this.tag(CCItemTags.ADDITIONAL_TOOLBOX_TOOLS).add(Items.SPYGLASS, MONOCLE.get(), Items.TOTEM_OF_UNDYING, TUNING_FORK.get(), Items.GOAT_HORN, COPPER_HORN.get(), LOST_GOAT_HORN.get(), BONE_FLUTE.get());
		...
		this.copy(CCBlockTags.STORAGE_BLOCKS_EXPOSED_COPPER, CCItemTags.STORAGE_BLOCKS_EXPOSED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_WEATHERED_COPPER, CCItemTags.STORAGE_BLOCKS_WEATHERED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_OXIDIZED_COPPER, CCItemTags.STORAGE_BLOCKS_OXIDIZED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_WAXED_COPPER, CCItemTags.STORAGE_BLOCKS_WAXED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_WAXED_EXPOSED_COPPER, CCItemTags.STORAGE_BLOCKS_WAXED_EXPOSED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_WAXED_WEATHERED_COPPER, CCItemTags.STORAGE_BLOCKS_WAXED_WEATHERED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_WAXED_OXIDIZED_COPPER, CCItemTags.STORAGE_BLOCKS_WAXED_OXIDIZED_COPPER);
		this.copy(CCBlockTags.STORAGE_BLOCKS_ALL_COPPER, CCItemTags.STORAGE_BLOCKS_ALL_COPPER);
		...
		this.tag(CCItemTags.COPPER_HORSE_ARMOR).add(COPPER_HORSE_ARMOR.get(), EXPOSED_COPPER_HORSE_ARMOR.get(), WEATHERED_COPPER_HORSE_ARMOR.get(), OXIDIZED_COPPER_HORSE_ARMOR.get(), WAXED_COPPER_HORSE_ARMOR.get(), WAXED_EXPOSED_COPPER_HORSE_ARMOR.get(), WAXED_WEATHERED_COPPER_HORSE_ARMOR.get(), WAXED_OXIDIZED_COPPER_HORSE_ARMOR.get());
		...
		this.tag(BlueprintItemTags.HORSE_ARMOR).addTag(CCItemTags.COPPER_HORSE_ARMOR).add(SILVER_HORSE_ARMOR.get(), NETHERITE_HORSE_ARMOR.get(), NECROMIUM_HORSE_ARMOR.get());
