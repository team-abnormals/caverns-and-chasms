...
public class CCItemTagsProvider extends BlueprintItemTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(ItemTags.TRIMMABLE_ARMOR).add(
				COPPER_HELMET.get(), COPPER_CHESTPLATE.get(), COPPER_LEGGINGS.get(), COPPER_BOOTS.get(),
				EXPOSED_COPPER_HELMET.get(), EXPOSED_COPPER_CHESTPLATE.get(), EXPOSED_COPPER_LEGGINGS.get(), EXPOSED_COPPER_BOOTS.get(),
				WEATHERED_COPPER_HELMET.get(), WEATHERED_COPPER_CHESTPLATE.get(), WEATHERED_COPPER_LEGGINGS.get(), WEATHERED_COPPER_BOOTS.get(),
				OXIDIZED_COPPER_HELMET.get(), OXIDIZED_COPPER_CHESTPLATE.get(), OXIDIZED_COPPER_LEGGINGS.get(), OXIDIZED_COPPER_BOOTS.get(),
				WAXED_COPPER_HELMET.get(), WAXED_COPPER_CHESTPLATE.get(), WAXED_COPPER_LEGGINGS.get(), WAXED_COPPER_BOOTS.get(),
				WAXED_EXPOSED_COPPER_HELMET.get(), WAXED_EXPOSED_COPPER_CHESTPLATE.get(), WAXED_EXPOSED_COPPER_LEGGINGS.get(), WAXED_EXPOSED_COPPER_BOOTS.get(),
				WAXED_WEATHERED_COPPER_HELMET.get(), WAXED_WEATHERED_COPPER_CHESTPLATE.get(), WAXED_WEATHERED_COPPER_LEGGINGS.get(), WAXED_WEATHERED_COPPER_BOOTS.get(),
				WAXED_OXIDIZED_COPPER_HELMET.get(), WAXED_OXIDIZED_COPPER_CHESTPLATE.get(), WAXED_OXIDIZED_COPPER_LEGGINGS.get(), WAXED_OXIDIZED_COPPER_BOOTS.get(),
		...
		this.tag(ItemTags.SWORDS).add(
				COPPER_SWORD.get(), EXPOSED_COPPER_SWORD.get(), WEATHERED_COPPER_SWORD.get(), OXIDIZED_COPPER_SWORD.get(),
				WAXED_COPPER_SWORD.get(), WAXED_EXPOSED_COPPER_SWORD.get(), WAXED_WEATHERED_COPPER_SWORD.get(), WAXED_OXIDIZED_COPPER_SWORD.get(),
				SILVER_SWORD.get(), NECROMIUM_SWORD.get()
		);
		this.tag(ItemTags.PICKAXES).add(
				COPPER_PICKAXE.get(), EXPOSED_COPPER_PICKAXE.get(), WEATHERED_COPPER_PICKAXE.get(), OXIDIZED_COPPER_PICKAXE.get(),
				WAXED_COPPER_PICKAXE.get(), WAXED_EXPOSED_COPPER_PICKAXE.get(), WAXED_WEATHERED_COPPER_PICKAXE.get(), WAXED_OXIDIZED_COPPER_PICKAXE.get(),
				SILVER_PICKAXE.get(), NECROMIUM_PICKAXE.get()
		);
		this.tag(ItemTags.AXES).add(
				COPPER_AXE.get(), EXPOSED_COPPER_AXE.get(), WEATHERED_COPPER_AXE.get(), OXIDIZED_COPPER_AXE.get(),
				WAXED_COPPER_AXE.get(), WAXED_EXPOSED_COPPER_AXE.get(), WAXED_WEATHERED_COPPER_AXE.get(), WAXED_OXIDIZED_COPPER_AXE.get(),
				SILVER_AXE.get(), NECROMIUM_AXE.get()
		);
		this.tag(ItemTags.HOES).add(
				COPPER_HOE.get(), EXPOSED_COPPER_HOE.get(), WEATHERED_COPPER_HOE.get(), OXIDIZED_COPPER_HOE.get(),
				WAXED_COPPER_HOE.get(), WAXED_EXPOSED_COPPER_HOE.get(), WAXED_WEATHERED_COPPER_HOE.get(), WAXED_OXIDIZED_COPPER_HOE.get(),
				SILVER_HOE.get(), NECROMIUM_HOE.get()
		);
		this.tag(ItemTags.SHOVELS).add(
				COPPER_SHOVEL.get(), EXPOSED_COPPER_SHOVEL.get(), WEATHERED_COPPER_SHOVEL.get(), OXIDIZED_COPPER_SHOVEL.get(),
				WAXED_COPPER_SHOVEL.get(), WAXED_EXPOSED_COPPER_SHOVEL.get(), WAXED_WEATHERED_COPPER_SHOVEL.get(), WAXED_OXIDIZED_COPPER_SHOVEL.get(),
				SILVER_SHOVEL.get(), NECROMIUM_SHOVEL.get()
		);

		this.tag(Tags.Items.ARMORS_HELMETS).add(
				COPPER_HELMET.get(), EXPOSED_COPPER_HELMET.get(), WEATHERED_COPPER_HELMET.get(), OXIDIZED_COPPER_HELMET.get(),
				WAXED_COPPER_HELMET.get(), WAXED_EXPOSED_COPPER_HELMET.get(), WAXED_WEATHERED_COPPER_HELMET.get(), WAXED_OXIDIZED_COPPER_HELMET.get(),
				SILVER_HELMET.get(), NECROMIUM_HELMET.get(), COWL.get()
		);
		this.tag(Tags.Items.ARMORS_CHESTPLATES).add(
				COPPER_CHESTPLATE.get(), EXPOSED_COPPER_CHESTPLATE.get(), WEATHERED_COPPER_CHESTPLATE.get(), OXIDIZED_COPPER_CHESTPLATE.get(),
				WAXED_COPPER_CHESTPLATE.get(), WAXED_EXPOSED_COPPER_CHESTPLATE.get(), WAXED_WEATHERED_COPPER_CHESTPLATE.get(), WAXED_OXIDIZED_COPPER_CHESTPLATE.get(),
				SILVER_CHESTPLATE.get(), NECROMIUM_CHESTPLATE.get()
		);
		this.tag(Tags.Items.ARMORS_LEGGINGS).add(
				COPPER_LEGGINGS.get(), EXPOSED_COPPER_LEGGINGS.get(), WEATHERED_COPPER_LEGGINGS.get(), OXIDIZED_COPPER_LEGGINGS.get(),
				WAXED_COPPER_LEGGINGS.get(), WAXED_EXPOSED_COPPER_LEGGINGS.get(), WAXED_WEATHERED_COPPER_LEGGINGS.get(), WAXED_OXIDIZED_COPPER_LEGGINGS.get(),
				SILVER_LEGGINGS.get(), NECROMIUM_LEGGINGS.get()
		);
		this.tag(Tags.Items.ARMORS_BOOTS).add(
				COPPER_BOOTS.get(), EXPOSED_COPPER_BOOTS.get(), WEATHERED_COPPER_BOOTS.get(), OXIDIZED_COPPER_BOOTS.get(),
				WAXED_COPPER_BOOTS.get(), WAXED_EXPOSED_COPPER_BOOTS.get(), WAXED_WEATHERED_COPPER_BOOTS.get(), WAXED_OXIDIZED_COPPER_BOOTS.get(),
				SILVER_BOOTS.get(), NECROMIUM_BOOTS.get()
		);
