...
public class CCItemTagsProvider extends ItemTagsProvider {
	...
	public void addTags() {
		...
		this.tag(CCItemTags.CUPRIC_FIRE_BASE_BLOCKS).add(Blocks.COPPER_BLOCK.asItem(), Blocks.EXPOSED_COPPER.asItem(), Blocks.WEATHERED_COPPER.asItem(), Blocks.OXIDIZED_COPPER.asItem(), Blocks.CUT_COPPER.asItem(), Blocks.EXPOSED_CUT_COPPER.asItem(), Blocks.WEATHERED_CUT_COPPER.asItem(), Blocks.OXIDIZED_CUT_COPPER.asItem(), Blocks.WAXED_COPPER_BLOCK.asItem(), Blocks.WAXED_EXPOSED_COPPER.asItem(), Blocks.WAXED_WEATHERED_COPPER.asItem(), Blocks.WAXED_OXIDIZED_COPPER.asItem(), Blocks.WAXED_CUT_COPPER.asItem(), Blocks.WAXED_EXPOSED_CUT_COPPER.asItem(), Blocks.WAXED_WEATHERED_CUT_COPPER.asItem(), Blocks.WAXED_OXIDIZED_CUT_COPPER.asItem());
