...
public class CCItemTagsProvider extends BlueprintItemTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(ItemTags.TRIM_TEMPLATES).add(EXILE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), FORGER_ARMOR_TRIM_SMITHING_TEMPLATE.get());
		...
		this.copy(CCBlockTags.STORAGE_BLOCKS_FLINT, CCItemTags.STORAGE_BLOCKS_FLINT);
