...
public class CCItemTagsProvider extends BlueprintItemTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(ItemTags.TRIM_TEMPLATES).add(EXILE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), FORGER_ARMOR_TRIM_SMITHING_TEMPLATE.get(), IMMOLATE_ARMOR_TRIM_SMITHING_TEMPLATE.get(), RIM_ARMOR_TRIM_SMITHING_TEMPLATE.get());
