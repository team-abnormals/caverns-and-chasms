...
public class CCRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(Consumer<FinishedRecipe> consumer) {
		...
		SimpleCookingRecipeBuilder.smelting(Ingredient.of(CCItemTags.SMELTS_TO_COPPER_INGOT), MISC, Items.COPPER_INGOT, 0.1F, 200).unlockedBy("has_copper_gear", has(CCItemTags.SMELTS_TO_COPPER_INGOT)).save(consumer, new ResourceLocation(CavernsAndChasms.MOD_ID, getSmeltingRecipeName(Items.COPPER_INGOT)));
		SimpleCookingRecipeBuilder.blasting(Ingredient.of(CCItemTags.SMELTS_TO_COPPER_INGOT), MISC, Items.COPPER_INGOT, 0.1F, 100).unlockedBy("has_copper_gear", has(CCItemTags.SMELTS_TO_COPPER_INGOT)).save(consumer, new ResourceLocation(CavernsAndChasms.MOD_ID, getBlastingRecipeName(Items.COPPER_INGOT)));
