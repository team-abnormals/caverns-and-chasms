...
//		ShapedRecipeBuilder.shaped(INDUCTOR.get()).define('C', Tags.Items.INGOTS_COPPER).define('I', Items.IRON_BLOCK).define('R', Items.REDSTONE).pattern("CIC").pattern("CRC").pattern("CIC").unlockedBy("has_copper_ingot", has(Tags.Items.INGOTS_COPPER)).save(consumer);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SANGUINE_TILE_SLAB.get(), SANGUINE_TILES.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SANGUINE_TILE_STAIRS.get(), SANGUINE_TILES.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SANGUINE_TILE_WALL.get(), SANGUINE_TILES.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, FORTIFIED_SANGUINE_TILE_SLAB.get(), FORTIFIED_SANGUINE_TILES.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, FORTIFIED_SANGUINE_TILE_STAIRS.get(), FORTIFIED_SANGUINE_TILES.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, FORTIFIED_SANGUINE_TILE_WALL.get(), FORTIFIED_SANGUINE_TILES.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, LAPIS_LAZULI_BRICK_SLAB.get(), LAPIS_LAZULI_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, LAPIS_LAZULI_BRICK_STAIRS.get(), LAPIS_LAZULI_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, LAPIS_LAZULI_BRICK_WALL.get(), LAPIS_LAZULI_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, LAPIS_LAZULI_PILLAR.get(), LAPIS_LAZULI_BRICKS.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SPINEL_BRICK_SLAB.get(), SPINEL_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SPINEL_BRICK_STAIRS.get(), SPINEL_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, SPINEL_BRICK_WALL.get(), SPINEL_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SPINEL_PILLAR.get(), SPINEL_BRICKS.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CALCITE_SLAB.get(), Blocks.CALCITE, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CALCITE_STAIRS.get(), Blocks.CALCITE);
		stonecutterResultFromBase(consumer, DECORATIONS, CALCITE_WALL.get(), Blocks.CALCITE);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_CALCITE.get(), Blocks.CALCITE);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_CALCITE_SLAB.get(), Blocks.CALCITE, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_CALCITE_STAIRS.get(), Blocks.CALCITE);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_CALCITE_SLAB.get(), POLISHED_CALCITE.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_CALCITE_STAIRS.get(), POLISHED_CALCITE.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, TUFF_SLAB.get(), Blocks.TUFF, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, TUFF_STAIRS.get(), Blocks.TUFF);
		stonecutterResultFromBase(consumer, DECORATIONS, TUFF_WALL.get(), Blocks.TUFF);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_TUFF.get(), Blocks.TUFF);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_TUFF_SLAB.get(), Blocks.TUFF, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_TUFF_STAIRS.get(), Blocks.TUFF);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_TUFF_SLAB.get(), POLISHED_TUFF.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_TUFF_STAIRS.get(), POLISHED_TUFF.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SUGILITE_SLAB.get(), SUGILITE.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, SUGILITE_STAIRS.get(), SUGILITE.get());
		stonecutterResultFromBase(consumer, DECORATIONS, SUGILITE_WALL.get(), SUGILITE.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_SUGILITE.get(), SUGILITE.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_SUGILITE_SLAB.get(), SUGILITE.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_SUGILITE_STAIRS.get(), SUGILITE.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_SUGILITE_SLAB.get(), POLISHED_SUGILITE.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, POLISHED_SUGILITE_STAIRS.get(), POLISHED_SUGILITE.get());
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, DRIPSTONE_SHINGLE_SLAB.get(), DRIPSTONE_SHINGLES.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, DRIPSTONE_SHINGLE_STAIRS.get(), DRIPSTONE_SHINGLES.get());
		stonecutterResultFromBase(consumer, DECORATIONS, DRIPSTONE_SHINGLE_WALL.get(), DRIPSTONE_SHINGLES.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CHISELED_DRIPSTONE_SHINGLES.get(), DRIPSTONE_SHINGLES.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, DRIPSTONE_SHINGLES.get(), Blocks.DRIPSTONE_BLOCK);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, DRIPSTONE_SHINGLE_SLAB.get(), Blocks.DRIPSTONE_BLOCK, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, DRIPSTONE_SHINGLE_STAIRS.get(), Blocks.DRIPSTONE_BLOCK);
		stonecutterResultFromBase(consumer, DECORATIONS, DRIPSTONE_SHINGLE_WALL.get(), Blocks.DRIPSTONE_BLOCK);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CHISELED_DRIPSTONE_SHINGLES.get(), Blocks.DRIPSTONE_BLOCK);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICK_SLAB.get(), CUT_AMETHYST_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICK_STAIRS.get(), CUT_AMETHYST_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, CUT_AMETHYST_BRICK_WALL.get(), CUT_AMETHYST_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICKS.get(), CUT_AMETHYST.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICK_SLAB.get(), CUT_AMETHYST.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICK_STAIRS.get(), CUT_AMETHYST.get());
		stonecutterResultFromBase(consumer, DECORATIONS, CUT_AMETHYST_BRICK_WALL.get(), CUT_AMETHYST.get());

		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST.get(), Blocks.AMETHYST_BLOCK);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICKS.get(), Blocks.AMETHYST_BLOCK);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICK_SLAB.get(), Blocks.AMETHYST_BLOCK, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, CUT_AMETHYST_BRICK_STAIRS.get(), Blocks.AMETHYST_BLOCK);
		stonecutterResultFromBase(consumer, DECORATIONS, CUT_AMETHYST_BRICK_WALL.get(), Blocks.AMETHYST_BLOCK);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_BRICK_SLAB.get(), COBBLESTONE_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_BRICK_STAIRS.get(), COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, COBBLESTONE_BRICK_WALL.get(), COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_BRICKS.get(), Blocks.COBBLESTONE);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_BRICK_SLAB.get(), Blocks.COBBLESTONE, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_BRICK_STAIRS.get(), Blocks.COBBLESTONE);
		stonecutterResultFromBase(consumer, DECORATIONS, COBBLESTONE_BRICK_WALL.get(), Blocks.COBBLESTONE);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILE_SLAB.get(), COBBLESTONE_TILES.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILE_STAIRS.get(), COBBLESTONE_TILES.get());
		stonecutterResultFromBase(consumer, DECORATIONS, COBBLESTONE_TILE_WALL.get(), COBBLESTONE_TILES.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILES.get(), COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILE_SLAB.get(), COBBLESTONE_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILE_STAIRS.get(), COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, COBBLESTONE_TILE_WALL.get(), COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILES.get(), Blocks.COBBLESTONE);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILE_SLAB.get(), Blocks.COBBLESTONE, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, COBBLESTONE_TILE_STAIRS.get(), Blocks.COBBLESTONE);
		stonecutterResultFromBase(consumer, DECORATIONS, COBBLESTONE_TILE_WALL.get(), Blocks.COBBLESTONE);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_BRICK_SLAB.get(), MOSSY_COBBLESTONE_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_BRICK_STAIRS.get(), MOSSY_COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, MOSSY_COBBLESTONE_BRICK_WALL.get(), MOSSY_COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_BRICKS.get(), Blocks.MOSSY_COBBLESTONE);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_BRICK_SLAB.get(), Blocks.MOSSY_COBBLESTONE, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_BRICK_STAIRS.get(), Blocks.MOSSY_COBBLESTONE);
		stonecutterResultFromBase(consumer, DECORATIONS, MOSSY_COBBLESTONE_BRICK_WALL.get(), Blocks.MOSSY_COBBLESTONE);
		...
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILE_SLAB.get(), MOSSY_COBBLESTONE_TILES.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILE_STAIRS.get(), MOSSY_COBBLESTONE_TILES.get());
		stonecutterResultFromBase(consumer, DECORATIONS, MOSSY_COBBLESTONE_TILE_WALL.get(), MOSSY_COBBLESTONE_TILES.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILES.get(), MOSSY_COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILE_SLAB.get(), MOSSY_COBBLESTONE_BRICKS.get(), 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILE_STAIRS.get(), MOSSY_COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, DECORATIONS, MOSSY_COBBLESTONE_TILE_WALL.get(), MOSSY_COBBLESTONE_BRICKS.get());
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILES.get(), Blocks.MOSSY_COBBLESTONE);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILE_SLAB.get(), Blocks.MOSSY_COBBLESTONE, 2);
		stonecutterResultFromBase(consumer, BUILDING_BLOCKS, MOSSY_COBBLESTONE_TILE_STAIRS.get(), Blocks.MOSSY_COBBLESTONE);
		stonecutterResultFromBase(consumer, DECORATIONS, MOSSY_COBBLESTONE_TILE_WALL.get(), Blocks.MOSSY_COBBLESTONE);
