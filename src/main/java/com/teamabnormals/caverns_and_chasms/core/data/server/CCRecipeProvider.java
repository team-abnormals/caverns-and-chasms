...
//		ShapedRecipeBuilder.shaped(INDUCTOR.get()).define('C', Tags.Items.INGOTS_COPPER).define('I', Items.IRON_BLOCK).define('R', Items.REDSTONE).pattern("CIC").pattern("CRC").pattern("CIC").unlockedBy("has_copper_ingot", has(Tags.Items.INGOTS_COPPER)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(DECORATIONS, CUPRIC_TORCH.get(), 4).define('X', Ingredient.of(Items.COAL, Items.CHARCOAL)).define('#', Tags.Items.RODS_WOODEN).define('C', CCItemTags.CUPRIC_FIRE_BASE_ITEMS).pattern("X").pattern("#").pattern("C").unlockedBy("has_copper", has(CCItemTags.CUPRIC_FIRE_BASE_ITEMS)).save(consumer);
		ShapedRecipeBuilder.shaped(DECORATIONS, CUPRIC_CAMPFIRE.get()).define('L', ItemTags.LOGS).define('S', Tags.Items.RODS_WOODEN).define('#', CCItemTags.CUPRIC_FIRE_BASE_ITEMS).pattern(" S ").pattern("S#S").pattern("LLL").unlockedBy("has_stick", has(Tags.Items.RODS_WOODEN)).unlockedBy("has_copper", has(CCItemTags.CUPRIC_FIRE_BASE_ITEMS)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(DECORATIONS, CUPRIC_BRAZIER.get()).define('#', CCItemTags.CUPRIC_FIRE_BASE_ITEMS).define('S', CCItemTags.INGOTS_SILVER).pattern("S#S").pattern(" S ").unlockedBy("has_silver_ingot", has(CCItemTags.INGOTS_SILVER)).unlockedBy("has_copper", has(CCItemTags.CUPRIC_FIRE_BASE_ITEMS)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(REDSTONE, STORAGE_DUCT.get()).define('I', CCItemTags.INGOTS_TIN).define('B', CCItemTags.STORAGE_BLOCKS_TIN).pattern("BIB").pattern("I I").pattern("BIB").unlockedBy("has_tin_ingot", has(CCItemTags.INGOTS_TIN)).save(consumer);
		...
		stonecutterRecipe(consumer, BUILDING_BLOCKS, CASSITERITE_BRICK_WALL.get(), CASSITERITE.get());
		...
		stonecutterRecipe(consumer, BUILDING_BLOCKS, CASSITERITE_BRICK_WALL.get(), POLISHED_CASSITERITE.get());
		...
		stonecutterRecipe(consumer, BUILDING_BLOCKS, CASSITERITE_BRICK_WALL.get(), CASSITERITE_BRICKS.get());
