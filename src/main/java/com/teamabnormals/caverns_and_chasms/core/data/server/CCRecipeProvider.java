...
public class CCRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(RecipeOutput consumer, Provider provider) {
		...
		copperIngotRecipes(consumer, Items.COPPER_INGOT, Blocks.COPPER_BLOCK, Blocks.COPPER_DOOR, Blocks.COPPER_TRAPDOOR, COPPER_BARS, LIFT_PRESSURE_PLATE, LIFT_BUTTON, Blocks.LIGHTNING_ROD, FLOODLIGHT, TOOLBOX);
		copperIngotRecipes(consumer, CCItems.EXPOSED_COPPER_INGOT, Blocks.EXPOSED_COPPER, Blocks.EXPOSED_COPPER_DOOR, Blocks.EXPOSED_COPPER_TRAPDOOR, EXPOSED_COPPER_BARS, EXPOSED_LIFT_PRESSURE_PLATE, EXPOSED_LIFT_BUTTON, EXPOSED_LIGHTNING_ROD, EXPOSED_FLOODLIGHT, EXPOSED_TOOLBOX);
		copperIngotRecipes(consumer, CCItems.WEATHERED_COPPER_INGOT, Blocks.WEATHERED_COPPER, Blocks.WEATHERED_COPPER_DOOR, Blocks.WEATHERED_COPPER_TRAPDOOR, WEATHERED_COPPER_BARS, WEATHERED_LIFT_PRESSURE_PLATE, WEATHERED_LIFT_BUTTON, WEATHERED_LIGHTNING_ROD, WEATHERED_FLOODLIGHT, WEATHERED_TOOLBOX);
		copperIngotRecipes(consumer, CCItems.OXIDIZED_COPPER_INGOT, Blocks.OXIDIZED_COPPER, Blocks.OXIDIZED_COPPER_DOOR, Blocks.OXIDIZED_COPPER_TRAPDOOR, OXIDIZED_COPPER_BARS, OXIDIZED_LIFT_PRESSURE_PLATE, OXIDIZED_LIFT_BUTTON, OXIDIZED_LIGHTNING_ROD, OXIDIZED_FLOODLIGHT, OXIDIZED_TOOLBOX);
		copperIngotRecipes(consumer, CCItems.WAXED_COPPER_INGOT, Blocks.WAXED_COPPER_BLOCK, Blocks.WAXED_COPPER_DOOR, Blocks.WAXED_COPPER_TRAPDOOR, WAXED_COPPER_BARS, WAXED_LIFT_PRESSURE_PLATE, WAXED_LIFT_BUTTON, WAXED_LIGHTNING_ROD, WAXED_FLOODLIGHT, WAXED_TOOLBOX);
		copperIngotRecipes(consumer, CCItems.WAXED_EXPOSED_COPPER_INGOT, Blocks.WAXED_EXPOSED_COPPER, Blocks.WAXED_EXPOSED_COPPER_DOOR, Blocks.WAXED_EXPOSED_COPPER_TRAPDOOR, WAXED_EXPOSED_COPPER_BARS, WAXED_EXPOSED_LIFT_PRESSURE_PLATE, WAXED_EXPOSED_LIFT_BUTTON, WAXED_EXPOSED_LIGHTNING_ROD, WAXED_EXPOSED_FLOODLIGHT, WAXED_EXPOSED_TOOLBOX);
		copperIngotRecipes(consumer, CCItems.WAXED_WEATHERED_COPPER_INGOT, Blocks.WAXED_WEATHERED_COPPER, Blocks.WAXED_WEATHERED_COPPER_DOOR, Blocks.WAXED_WEATHERED_COPPER_TRAPDOOR, WAXED_WEATHERED_COPPER_BARS, WAXED_WEATHERED_LIFT_PRESSURE_PLATE, WAXED_WEATHERED_LIFT_BUTTON, WAXED_WEATHERED_LIGHTNING_ROD, WAXED_WEATHERED_FLOODLIGHT, WAXED_WEATHERED_TOOLBOX);
		copperIngotRecipes(consumer, CCItems.WAXED_OXIDIZED_COPPER_INGOT, Blocks.WAXED_OXIDIZED_COPPER, Blocks.WAXED_OXIDIZED_COPPER_DOOR, Blocks.WAXED_OXIDIZED_COPPER_TRAPDOOR, WAXED_OXIDIZED_COPPER_BARS, WAXED_OXIDIZED_LIFT_PRESSURE_PLATE, WAXED_OXIDIZED_LIFT_BUTTON, WAXED_OXIDIZED_LIGHTNING_ROD, WAXED_OXIDIZED_FLOODLIGHT, WAXED_OXIDIZED_TOOLBOX);
		...
		ShapedRecipeBuilder.shaped(DECORATIONS, SILVER_CHAIN).define('#', CCItemTags.NUGGETS_SILVER).pattern("#").pattern("#").pattern("#").unlockedBy("has_silver_nugget", has(CCItemTags.NUGGETS_SILVER)).save(consumer);
		...
		ShapedRecipeBuilder.shaped(DECORATIONS, GOLDEN_CHAIN).define('#', Tags.Items.NUGGETS_GOLD).pattern("#").pattern("#").pattern("#").unlockedBy("has_gold_nugget", has(Tags.Items.NUGGETS_GOLD)).save(consumer);
