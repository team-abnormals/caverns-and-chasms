...
public class CCRecipeProvider extends BlueprintRecipeProvider {
	...
	public void buildRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(DECORATIONS, DUCT_DOOR.get()).define('I', CCItemTags.INGOTS_TIN).pattern("I I").pattern("I I").pattern("I I").unlockedBy("has_tin_ingot", has(CCItemTags.INGOTS_TIN)).save(consumer);
