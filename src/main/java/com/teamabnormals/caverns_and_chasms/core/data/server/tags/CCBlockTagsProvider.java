...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.STAIRS).add(CCBlocks.DIRT_BRICK_STAIRS.get(), CCBlocks.DIRT_TILE_STAIRS.get(), CCBlocks.COBBLESTONE_BRICK_STAIRS.get(), CCBlocks.COBBLESTONE_TILE_STAIRS.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_STAIRS.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_STAIRS.get(), CCBlocks.SPINEL_BRICK_STAIRS.get(), CCBlocks.LAPIS_LAZULI_BRICK_STAIRS.get(), CCBlocks.SANGUINE_STAIRS.get(), CCBlocks.DRIPSTONE_SHINGLE_STAIRS.get());
		this.tag(BlockTags.WALL_POST_OVERRIDE).add(CCBlocks.CURSED_TORCH.get());
		this.tag(BlockTags.WALLS).add(CCBlocks.DIRT_BRICK_WALL.get(), CCBlocks.DIRT_TILE_WALL.get(), CCBlocks.COBBLESTONE_BRICK_WALL.get(), CCBlocks.COBBLESTONE_TILE_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_WALL.get(), CCBlocks.SPINEL_BRICK_WALL.get(), CCBlocks.LAPIS_LAZULI_BRICK_WALL.get(), CCBlocks.DRIPSTONE_SHINGLE_WALL.get());
