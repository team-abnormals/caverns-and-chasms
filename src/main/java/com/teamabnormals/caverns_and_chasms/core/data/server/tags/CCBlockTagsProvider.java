...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.COMBINATION_STEP_SOUND_BLOCKS).addTag(CCBlockTags.CAVE_GROWTHS);
		this.tag(BlockTags.INSIDE_STEP_SOUND_BLOCKS).addTag(CCBlockTags.CAVE_GROWTHS);
