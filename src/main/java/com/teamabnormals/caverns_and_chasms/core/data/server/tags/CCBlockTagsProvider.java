...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				CALCITE_STAIRS.get(), CALCITE_SLAB.get(), CALCITE_WALL.get(), POLISHED_CALCITE.get(), POLISHED_CALCITE_STAIRS.get(), POLISHED_CALCITE_SLAB.get(), POLISHED_TUFF_WALL.get(),
