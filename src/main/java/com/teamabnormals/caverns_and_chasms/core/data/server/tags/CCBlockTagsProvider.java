...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				ROLLER_DOOR.get(), ROLLER_DOOR_BOTTOM.get(), ROLLER_DOOR_HEADER.get(), ROLLER_DOOR_HEADER_BOTTOM.get(),
		...
		this.tag(BlockTags.NEEDS_IRON_TOOL).add(SILVER_BLOCK.get(), RAW_SILVER_BLOCK.get(), SILVER_ORE.get(), DEEPSLATE_SILVER_ORE.get(), ZIRCONIA_BLOCK.get());
		this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(TIN_BLOCK.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), CASSITERITE_TIN_ORE.get(), TIN_BARS.get(), HOLD_PLATE.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), STORAGE_DUCT.get(), SCATTERER.get(), SPLURTER.get(), ROLLER_DOOR.get(), ROLLER_DOOR_BOTTOM.get(), ROLLER_DOOR_HEADER.get(), ROLLER_DOOR_HEADER_BOTTOM.get(), NECROMIUM_BLOCK.get());
