...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.WALLS).add(CCBlocks.COBBLESTONE_BRICK_WALL.get(), CCBlocks.COBBLESTONE_TILE_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_WALL.get(), CCBlocks.SPINEL_BRICK_WALL.get(), CCBlocks.LAPIS_LAZULI_BRICK_WALL.get(), CCBlocks.DRIPSTONE_SHINGLE_WALL.get(), CCBlocks.CALCITE_WALL.get(), CCBlocks.TUFF_WALL.get());
