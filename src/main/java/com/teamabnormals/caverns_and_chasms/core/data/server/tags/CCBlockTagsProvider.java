...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.DIRT).add(CCBlocks.ROCKY_DIRT.get());
		...
		this.tag(BlockTags.SLABS).add(CCBlocks.COBBLESTONE_BRICK_SLAB.get(), CCBlocks.COBBLESTONE_TILE_SLAB.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_SLAB.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_SLAB.get(), CCBlocks.SPINEL_BRICK_SLAB.get(), CCBlocks.LAPIS_LAZULI_BRICK_SLAB.get(), CCBlocks.SANGUINE_SLAB.get(), CCBlocks.DRIPSTONE_SHINGLE_SLAB.get(), CCBlocks.CALCITE_SLAB.get(), CCBlocks.POLISHED_CALCITE_SLAB.get(), CCBlocks.TUFF_SLAB.get(), CCBlocks.POLISHED_TUFF_SLAB.get(), CCBlocks.CUT_AMETHYST_BRICK_SLAB.get());
		...
		this.tag(BlockTags.STAIRS).add(CCBlocks.COBBLESTONE_BRICK_STAIRS.get(), CCBlocks.COBBLESTONE_TILE_STAIRS.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_STAIRS.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_STAIRS.get(), CCBlocks.SPINEL_BRICK_STAIRS.get(), CCBlocks.LAPIS_LAZULI_BRICK_STAIRS.get(), CCBlocks.SANGUINE_STAIRS.get(), CCBlocks.DRIPSTONE_SHINGLE_STAIRS.get(), CCBlocks.CALCITE_STAIRS.get(), CCBlocks.POLISHED_CALCITE_STAIRS.get(), CCBlocks.TUFF_STAIRS.get(), CCBlocks.POLISHED_TUFF_STAIRS.get(), CCBlocks.CUT_AMETHYST_BRICK_STAIRS.get());
		this.tag(BlockTags.WALL_POST_OVERRIDE).add(CCBlocks.CUPRIC_TORCH.get());
		this.tag(BlockTags.WALLS).add(CCBlocks.COBBLESTONE_BRICK_WALL.get(), CCBlocks.COBBLESTONE_TILE_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_WALL.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_WALL.get(), CCBlocks.SPINEL_BRICK_WALL.get(), CCBlocks.LAPIS_LAZULI_BRICK_WALL.get(), CCBlocks.DRIPSTONE_SHINGLE_WALL.get(), CCBlocks.CALCITE_WALL.get(), CCBlocks.TUFF_WALL.get(), CCBlocks.CUT_AMETHYST_BRICK_WALL.get());
		...
		this.tag(BlockTags.CRYSTAL_SOUND_BLOCKS).add(CCBlocks.AMETHYST_BLOCK.get(), CCBlocks.CUT_AMETHYST.get(), CCBlocks.CUT_AMETHYST.get(), CCBlocks.CUT_AMETHYST_BRICKS.get(), CCBlocks.CUT_AMETHYST_BRICK_STAIRS.get(), CCBlocks.CUT_AMETHYST_BRICK_SLAB.get(), CCBlocks.CUT_AMETHYST_BRICK_WALL.get(), CCBlocks.CUT_AMETHYST_BRICK_VERTICAL_SLAB.get());
		...
		this.tag(BlueprintBlockTags.VERTICAL_SLABS).add(CCBlocks.COBBLESTONE_BRICK_VERTICAL_SLAB.get(), CCBlocks.COBBLESTONE_TILE_VERTICAL_SLAB.get(), CCBlocks.MOSSY_COBBLESTONE_BRICK_VERTICAL_SLAB.get(), CCBlocks.MOSSY_COBBLESTONE_TILE_VERTICAL_SLAB.get(), CCBlocks.SPINEL_BRICK_VERTICAL_SLAB.get(), CCBlocks.LAPIS_LAZULI_BRICK_VERTICAL_SLAB.get(), CCBlocks.SANGUINE_VERTICAL_SLAB.get(), CCBlocks.DRIPSTONE_SHINGLE_VERTICAL_SLAB.get(), CCBlocks.CALCITE_VERTICAL_SLAB.get(), CCBlocks.POLISHED_CALCITE_VERTICAL_SLAB.get(), CCBlocks.TUFF_VERTICAL_SLAB.get(), CCBlocks.POLISHED_TUFF_VERTICAL_SLAB.get(), CCBlocks.CUT_AMETHYST_BRICK_VERTICAL_SLAB.get());
