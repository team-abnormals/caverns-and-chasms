...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(TIN_BLOCK.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), TIN_BARS.get(), HOOP.get(), NECROMIUM_BLOCK.get());
		...
		this.tag(CCBlockTags.DEFLECTS_PROJECTILES).add(TIN_BLOCK.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), TIN_BARS.get(), TIN_BRICKS.get(), TIN_BRICK_STAIRS.get(), TIN_BRICK_SLAB.get(), TIN_BRICK_WALL.get(), CHISELED_TIN_BRICKS.get(), FLOAT_GLASS.get(), FLOAT_GLASS_PANE.get(), HOOP.get()).addTag(CCBlockTags.MAINTAINS_DEFLECT_VELOCITY);
