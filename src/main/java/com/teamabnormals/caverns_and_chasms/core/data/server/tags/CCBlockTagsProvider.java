...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(Tags.Blocks.STONES).add(POLISHED_CALCITE.get(), POLISHED_TUFF.get(), SUGILITE.get(), POLISHED_SUGILITE.get(), CYLINDRITE.get(), SMOOTH_CYLINDRITE.get(), POLISHED_CYLINDRITE.get(), CASSITERITE.get(), SMOOTH_CASSITERITE.get(), POLISHED_CASSITERITE.get(), RHYOLITE.get(), POLISHED_RHYOLITE.get(), FRAGILE_STONE.get(), FRAGILE_DEEPSLATE.get());
