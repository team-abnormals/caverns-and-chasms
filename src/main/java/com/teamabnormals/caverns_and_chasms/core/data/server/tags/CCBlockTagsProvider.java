...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.NEEDS_IRON_TOOL).add(SILVER_BLOCK.get(), RAW_SILVER_BLOCK.get(), SILVER_ORE.get(), DEEPSLATE_SILVER_ORE.get(), SANGUINE_PLATES.get(), SANGUINE_SLAB.get(), SANGUINE_STAIRS.get());
