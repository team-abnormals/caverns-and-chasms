...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		// INDUCTOR.get()
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ROCKY_DIRT.get(), FRAGILE_STONE.get(), FRAGILE_DEEPSLATE.get(), SILVER_BLOCK.get(), RAW_SILVER_BLOCK.get(), SILVER_ORE.get(), DEEPSLATE_SILVER_ORE.get(), SILVER_BARS.get(), MEDIUM_WEIGHTED_PRESSURE_PLATE.get(), SILVER_BUTTON.get(), SPIKED_RAIL.get(), SANGUINE_PLATES.get(), SANGUINE_STAIRS.get(), SANGUINE_SLAB.get(), SANGUINE_VERTICAL_SLAB.get(), CUPRIC_LANTERN.get(), BRAZIER.get(), SOUL_BRAZIER.get(), CUPRIC_BRAZIER.get(), ENDER_BRAZIER.get(), LAVA_LAMP.get(), GOLDEN_BARS.get(), SPINEL_BLOCK.get(), SPINEL_LAMP.get(), SPINEL_PILLAR.get(), SPINEL_BRICKS.get(), SPINEL_BRICK_STAIRS.get(), SPINEL_BRICK_SLAB.get(), SPINEL_BRICK_WALL.get(), SPINEL_BRICK_VERTICAL_SLAB.get(), SPINEL_ORE.get(), DEEPSLATE_SPINEL_ORE.get(), NECROMIUM_BLOCK.get(), LAPIS_LAZULI_LAMP.get(), LAPIS_LAZULI_PILLAR.get(), LAPIS_LAZULI_BRICKS.get(), LAPIS_LAZULI_BRICK_STAIRS.get(), LAPIS_LAZULI_BRICK_SLAB.get(), LAPIS_LAZULI_BRICK_WALL.get(), LAPIS_LAZULI_BRICK_VERTICAL_SLAB.get(), COBBLESTONE_BRICKS.get(), COBBLESTONE_BRICK_STAIRS.get(), COBBLESTONE_BRICK_SLAB.get(), COBBLESTONE_BRICK_WALL.get(), COBBLESTONE_BRICK_VERTICAL_SLAB.get(), COBBLESTONE_TILES.get(), COBBLESTONE_TILE_STAIRS.get(), COBBLESTONE_TILE_SLAB.get(), COBBLESTONE_TILE_WALL.get(), COBBLESTONE_TILE_VERTICAL_SLAB.get(), MOSSY_COBBLESTONE_BRICKS.get(), MOSSY_COBBLESTONE_BRICK_STAIRS.get(), MOSSY_COBBLESTONE_BRICK_SLAB.get(), MOSSY_COBBLESTONE_BRICK_WALL.get(), MOSSY_COBBLESTONE_BRICK_VERTICAL_SLAB.get(), MOSSY_COBBLESTONE_TILES.get(), MOSSY_COBBLESTONE_TILE_STAIRS.get(), MOSSY_COBBLESTONE_TILE_SLAB.get(), MOSSY_COBBLESTONE_TILE_WALL.get(), MOSSY_COBBLESTONE_TILE_VERTICAL_SLAB.get(), COPPER_BARS.get(), EXPOSED_COPPER_BARS.get(), WEATHERED_COPPER_BARS.get(), OXIDIZED_COPPER_BARS.get(), WAXED_COPPER_BARS.get(), WAXED_EXPOSED_COPPER_BARS.get(), WAXED_WEATHERED_COPPER_BARS.get(), WAXED_OXIDIZED_COPPER_BARS.get(), COPPER_BUTTON.get(), EXPOSED_COPPER_BUTTON.get(), WEATHERED_COPPER_BUTTON.get(), OXIDIZED_COPPER_BUTTON.get(), WAXED_COPPER_BUTTON.get(), WAXED_EXPOSED_COPPER_BUTTON.get(), WAXED_WEATHERED_COPPER_BUTTON.get(), WAXED_OXIDIZED_COPPER_BUTTON.get(), DRIPSTONE_SHINGLES.get(), DRIPSTONE_SHINGLE_STAIRS.get(), DRIPSTONE_SHINGLE_SLAB.get(), DRIPSTONE_SHINGLE_WALL.get(), CHISELED_DRIPSTONE_SHINGLES.get(), FLOODED_DRIPSTONE_SHINGLES.get(), CALCITE_STAIRS.get(), CALCITE_SLAB.get(), CALCITE_WALL.get(), CALCITE_VERTICAL_SLAB.get(), POLISHED_CALCITE.get(), POLISHED_CALCITE_STAIRS.get(), POLISHED_CALCITE_SLAB.get(), POLISHED_CALCITE_VERTICAL_SLAB.get(), TUFF_STAIRS.get(), TUFF_SLAB.get(), TUFF_WALL.get(), TUFF_VERTICAL_SLAB.get(), POLISHED_TUFF.get(), POLISHED_TUFF_STAIRS.get(), POLISHED_TUFF_SLAB.get(), POLISHED_TUFF_VERTICAL_SLAB.get(), FLOODLIGHT.get(), AMETHYST_BLOCK.get(), CUT_AMETHYST.get(), CUT_AMETHYST.get(), CUT_AMETHYST_BRICKS.get(), CUT_AMETHYST_BRICK_STAIRS.get(), CUT_AMETHYST_BRICK_SLAB.get(), CUT_AMETHYST_BRICK_WALL.get(), CUT_AMETHYST_BRICK_VERTICAL_SLAB.get());
