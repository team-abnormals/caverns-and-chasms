...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.RAILS).add(COPPER_RAIL.get(), EXPOSED_COPPER_RAIL.get(), WEATHERED_COPPER_RAIL.get(), OXIDIZED_COPPER_RAIL.get(),
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				SPINEL_PILLAR.get(), SPINEL_BRICKS.get(), SPINEL_BRICK_STAIRS.get(), SPINEL_BRICK_SLAB.get(), SPINEL_BRICK_WALL.get(), SPINEL_ORE.get(), DEEPSLATE_SPINEL_ORE.get(),
				NECROMIUM_BLOCK.get(),
