...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BlockTags.BASE_STONE_OVERWORLD).add(CCBlocks.FRAGILE_STONE.get());
		...
		this.tag(CCBlockTags.DEEPER_SPAWNABLE_BLOCKS).add(Blocks.GRAVEL).addTag(BlockTags.BASE_STONE_OVERWORLD).addTag(Tags.Blocks.ORES);
