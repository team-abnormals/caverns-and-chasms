...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(CCBlockTags.WINCH_DOES_NOT_UNWIND_ON).add(TIN_BLOCK.get(), BOUNCER.get());
		this.tag(CCBlockTags.WINCH_FORCES_UNWIND_ON).add(TINPLATE_BLOCK.get(), BOUNCER.get());
