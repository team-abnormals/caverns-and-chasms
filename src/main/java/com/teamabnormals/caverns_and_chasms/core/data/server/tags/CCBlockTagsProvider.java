...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(CCBlockTags.DEFLECTS_PROJECTILES).add(TIN_BLOCK.get(), TIN_INGOT.get(), RAW_TIN_BLOCK.get(), TIN_BARS.get(), TIN_CHAIN.get(), TIN_BULB.get(), TIN_BRICKS.get(), TIN_BRICK_STAIRS.get(), TIN_BRICK_SLAB.get(), TIN_BRICK_WALL.get(), CHISELED_TIN_BRICKS.get(), FLOAT_GLASS.get(), FLOAT_GLASS_PANE.get(), FROSTED_GLASS.get(), FROSTED_GLASS_PANE.get(), HOLD_PLATE.get(), HOLD_BUTTON.get(), WINCH.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), SPLURTER.get(), SCATTERER.get(), STORAGE_DUCT.get(), STORAGE_DUCT_HATCH.get(), ROLLER_DOOR.get(), ROLLER_DOOR_HEADER.get(), SADDLED_EGG.get()).addTag(CCBlockTags.WEAKER_DEFLECT_VELOCITY).addTag(CCBlockTags.MAINTAINS_DEFLECT_VELOCITY);
