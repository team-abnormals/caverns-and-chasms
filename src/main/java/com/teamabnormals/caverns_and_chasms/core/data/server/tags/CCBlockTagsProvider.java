...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				STONE_WALL.get(),
				POLISHED_GRANITE_WALL.get(), CHISELED_POLISHED_GRANITE.get(), GRANITE_BRICKS.get(), GRANITE_BRICK_STAIRS.get(), GRANITE_BRICK_SLAB.get(), GRANITE_BRICK_WALL.get(), CHISELED_GRANITE_BRICKS.get(),
				GRANITE_TILES.get(), GRANITE_TILE_STAIRS.get(), GRANITE_TILE_SLAB.get(), GRANITE_TILE_WALL.get(),
				POLISHED_DIORITE_WALL.get(), CHISELED_POLISHED_DIORITE.get(), DIORITE_BRICKS.get(), DIORITE_BRICK_STAIRS.get(), DIORITE_BRICK_SLAB.get(), DIORITE_BRICK_WALL.get(),
				DIORITE_TILES.get(), DIORITE_TILE_STAIRS.get(), DIORITE_TILE_SLAB.get(), DIORITE_TILE_WALL.get(), SMOOTH_DIORITE.get(), SMOOTH_DIORITE_STAIRS.get(), SMOOTH_DIORITE_SLAB.get(),
				...
				CYLINDRITE.get(), POLISHED_CYLINDRITE.get(), POLISHED_CYLINDRITE_STAIRS.get(), POLISHED_CYLINDRITE_SLAB.get(), POLISHED_CYLINDRITE_WALL.get(),
		...
		this.tag(BlockTags.CRYSTAL_SOUND_BLOCKS).addTag(CCBlockTags.FLOODLIGHTS).add(AMETHYST_BLOCK.get(), CUT_AMETHYST.get(), CUT_AMETHYST.get(), CUT_AMETHYST_BRICKS.get(), CUT_AMETHYST_BRICK_STAIRS.get(), CUT_AMETHYST_BRICK_SLAB.get(), CUT_AMETHYST_BRICK_WALL.get(), AMETHYST_LAMP.get(), REFRACTOR.get());
		...
		this.tag(CCBlockTags.WINCH_DOES_NOT_UNWIND_ON).add(SILVER_BLOCK.get());
		this.tag(CCBlockTags.WINCH_FORCES_UNWIND_ON).add(Blocks.GOLD_BLOCK);
