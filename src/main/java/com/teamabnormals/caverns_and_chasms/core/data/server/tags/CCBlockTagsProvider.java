...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(CCBlockTags.DEFLECTS_PROJECTILES).add(TIN_BLOCK.get(), TIN_INGOT.get(), RAW_TIN_BLOCK.get(), TIN_BARS.get(), TIN_CHAIN.get(), TIN_BULB.get(), TIN_BRICKS.get(), TIN_BRICK_STAIRS.get(), TIN_BRICK_SLAB.get(), TIN_BRICK_WALL.get(), CHISELED_TIN_BRICKS.get(), FLOAT_GLASS.get(), FLOAT_GLASS_PANE.get(), HOLD_PLATE.get(), HOLD_BUTTON.get(), WINCH.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), SPLURTER.get(), SCATTERER.get(), STORAGE_DUCT.get(), STORAGE_DUCT_HATCH.get(), ROLLER_DOOR.get(), ROLLER_DOOR_HEADER.get(), RESISTOR.get(), REFRACTOR.get(), SADDLED_EGG.get(), TINPLATE_BLOCK.get()).addTag(CCBlockTags.WEAKER_DEFLECT_VELOCITY).addTag(CCBlockTags.WEAKEST_DEFLECT_VELOCITY).addTag(CCBlockTags.MAINTAINS_DEFLECT_VELOCITY);
		this.tag(CCBlockTags.WEAKER_DEFLECT_VELOCITY).add(CASSITERITE.get(), CASSITERITE_STAIRS.get(), CASSITERITE_SLAB.get(), CASSITERITE_WALL.get(), SMOOTH_CASSITERITE.get(), SMOOTH_CASSITERITE_STAIRS.get(), SMOOTH_CASSITERITE_SLAB.get(), CASSITERITE_BRICKS.get(), CASSITERITE_BRICK_STAIRS.get(), CASSITERITE_BRICK_SLAB.get(), CASSITERITE_BRICK_WALL.get(), CASSITERITE_PILLAR.get(), CHISELED_CASSITERITE_BRICKS.get(), POLISHED_CASSITERITE.get(), POLISHED_CASSITERITE_STAIRS.get(), POLISHED_CASSITERITE_SLAB.get(), POLISHED_CASSITERITE_WALL.get()).addTag(CCBlockTags.TIN_ORES);
		this.tag(CCBlockTags.WEAKEST_DEFLECT_VELOCITY).add(CYLINDRITE.get(), SMOOTH_CYLINDRITE.get(), SMOOTH_CYLINDRITE_STAIRS.get(), SMOOTH_CYLINDRITE_SLAB.get(), CYLINDRITE_BRICKS.get(), CYLINDRITE_BRICK_STAIRS.get(), CYLINDRITE_BRICK_SLAB.get(), CYLINDRITE_BRICK_WALL.get(), CYLINDRITE_PILLAR.get(), CHISELED_CYLINDRITE_BRICKS.get(), POLISHED_CYLINDRITE.get(), POLISHED_CYLINDRITE_STAIRS.get(), POLISHED_CYLINDRITE_SLAB.get(), POLISHED_CYLINDRITE_WALL.get());
		this.tag(CCBlockTags.MAINTAINS_DEFLECT_VELOCITY).add(BOUNCER.get());
		this.tag(CCBlockTags.HAS_BONUS_DEFLECT).add(TINPLATE_BLOCK.get());
