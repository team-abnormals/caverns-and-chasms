...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				HOLD_PLATE.get(), HOLD_BUTTON.get(), WINCH.get(), DIMMER.get(), WALL_DIMMER.get(), BOUNCER.get(), HOOP.get(), STORAGE_DUCT.get(), STORAGE_DUCT_HATCH.get(),
				ROLLER_DOOR.get(), ROLLER_DOOR_HEADER.get(), ROLLER_WINDOW.get(), ROLLER_WINDOW_HEADER.get(),
		...
		this.tag(BlockTags.CRYSTAL_SOUND_BLOCKS).add(AMETHYST_BLOCK.get(), CUT_AMETHYST.get(), CUT_AMETHYST.get(), CUT_AMETHYST_BRICKS.get(), CUT_AMETHYST_BRICK_STAIRS.get(), CUT_AMETHYST_BRICK_SLAB.get(), CUT_AMETHYST_BRICK_WALL.get(), AMETHYST_LAMP.get());
