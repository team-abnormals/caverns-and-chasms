...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				HOLD_PLATE.get(), HOLD_BUTTON.get(), DIMMER.get(), WALL_DIMMER.get(), BOUNCER.get(), HOOP.get(),
				...
				TURQUOISE_PILLAR.get(), TURQUOISE_TILES.get(), TURQUOISE_TILE_STAIRS.get(), TURQUOISE_TILE_SLAB.get(), TURQUOISE_TILE_WALL.get(), TURQUOISE_ORE.get(), DEEPSLATE_TURQUOISE_ORE.get(),
				NECROMIUM_BLOCK.get(),
		...
		this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(TIN_BLOCK.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), CASSITERITE_TIN_ORE.get(), TIN_BARS.get(), HOLD_PLATE.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), NECROMIUM_BLOCK.get());
		...
		this.tag(CCBlockTags.DEFLECTS_PROJECTILES).add(TIN_BLOCK.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), CASSITERITE_TIN_ORE.get(), TIN_BARS.get(), TIN_BRICKS.get(), TIN_BRICK_STAIRS.get(), TIN_BRICK_SLAB.get(), TIN_BRICK_WALL.get(), CHISELED_TIN_BRICKS.get(), FLOAT_GLASS.get(), FLOAT_GLASS_PANE.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), SPLURTER.get()).addTag(CCBlockTags.MAINTAINS_DEFLECT_VELOCITY);
