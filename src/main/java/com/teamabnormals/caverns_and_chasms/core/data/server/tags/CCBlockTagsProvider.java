...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.SLABS).add(COBBLESTONE_BRICK_SLAB.get(), COBBLESTONE_TILE_SLAB.get(), MOSSY_COBBLESTONE_BRICK_SLAB.get(), MOSSY_COBBLESTONE_TILE_SLAB.get(), SPINEL_BRICK_SLAB.get(), LAPIS_LAZULI_BRICK_SLAB.get(), SANGUINE_TILE_SLAB.get(), FORTIFIED_SANGUINE_TILE_SLAB.get(), DRIPSTONE_SHINGLE_SLAB.get(), CALCITE_SLAB.get(), POLISHED_CALCITE_SLAB.get(), TUFF_SLAB.get(), POLISHED_TUFF_SLAB.get(), SUGILITE_SLAB.get(), POLISHED_SUGILITE_SLAB.get(), CUT_AMETHYST_BRICK_SLAB.get());
		...
		this.tag(BlockTags.STAIRS).add(COBBLESTONE_BRICK_STAIRS.get(), COBBLESTONE_TILE_STAIRS.get(), MOSSY_COBBLESTONE_BRICK_STAIRS.get(), MOSSY_COBBLESTONE_TILE_STAIRS.get(), SPINEL_BRICK_STAIRS.get(), LAPIS_LAZULI_BRICK_STAIRS.get(), SANGUINE_TILE_STAIRS.get(), FORTIFIED_SANGUINE_TILE_WALL.get(), DRIPSTONE_SHINGLE_STAIRS.get(), CALCITE_STAIRS.get(), POLISHED_CALCITE_STAIRS.get(), TUFF_STAIRS.get(), POLISHED_TUFF_STAIRS.get(), SUGILITE_STAIRS.get(), POLISHED_SUGILITE_STAIRS.get(), CUT_AMETHYST_BRICK_STAIRS.get());
		this.tag(BlockTags.WALL_POST_OVERRIDE).add(CUPRIC_TORCH.get());
		this.tag(BlockTags.WALLS).add(COBBLESTONE_BRICK_WALL.get(), COBBLESTONE_TILE_WALL.get(), MOSSY_COBBLESTONE_BRICK_WALL.get(), MOSSY_COBBLESTONE_TILE_WALL.get(), SPINEL_BRICK_WALL.get(), LAPIS_LAZULI_BRICK_WALL.get(), SANGUINE_TILE_WALL.get(), FORTIFIED_SANGUINE_TILE_WALL.get(), DRIPSTONE_SHINGLE_WALL.get(), CALCITE_WALL.get(), TUFF_WALL.get(), SUGILITE_WALL.get(), CUT_AMETHYST_BRICK_WALL.get());
