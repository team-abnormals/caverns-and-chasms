...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(CCBlockTags.WEAKEST_DEFLECT_VELOCITY).add(CYLINDRITE.get(), POLISHED_CYLINDRITE.get(), POLISHED_CYLINDRITE_STAIRS.get(), POLISHED_CYLINDRITE_SLAB.get(), POLISHED_CYLINDRITE_WALL.get());
		...
		this.tag(Tags.Blocks.STONE).add(POLISHED_CALCITE.get(), POLISHED_TUFF.get(), SUGILITE.get(), POLISHED_SUGILITE.get(), CYLINDRITE.get(), POLISHED_CYLINDRITE.get(), CASSITERITE.get(), SMOOTH_CASSITERITE.get(), POLISHED_CASSITERITE.get(), RHYOLITE.get(), POLISHED_RHYOLITE.get(), FRAGILE_STONE.get(), FRAGILE_DEEPSLATE.get());
