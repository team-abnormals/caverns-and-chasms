...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.SLABS).add(COBBLESTONE_BRICK_SLAB.get(), COBBLESTONE_TILE_SLAB.get(), MOSSY_COBBLESTONE_BRICK_SLAB.get(), MOSSY_COBBLESTONE_TILE_SLAB.get(), COBBLED_DEEPSLATE_BRICK_SLAB.get(), COBBLED_DEEPSLATE_TILE_SLAB.get(), SPINEL_BRICK_SLAB.get(), LAPIS_LAZULI_BRICK_SLAB.get(), TURQUOISE_TILE_SLAB.get(), SANGUINE_TILE_SLAB.get(), FORTIFIED_SANGUINE_TILE_SLAB.get(), DRIPSTONE_SHINGLE_SLAB.get(), CALCITE_SLAB.get(), POLISHED_CALCITE_SLAB.get(), TUFF_SLAB.get(), POLISHED_TUFF_SLAB.get(), SUGILITE_SLAB.get(), POLISHED_SUGILITE_SLAB.get(), CUT_AMETHYST_BRICK_SLAB.get(), IRON_BRICK_SLAB.get(), TIN_BRICK_SLAB.get(), GOLD_BRICK_SLAB.get(), SILVER_BRICK_SLAB.get(), COPPER_BRICK_SLAB.get(), EXPOSED_COPPER_BRICK_SLAB.get(), WEATHERED_COPPER_BRICK_SLAB.get(), OXIDIZED_COPPER_BRICK_SLAB.get(), WAXED_COPPER_BRICK_SLAB.get(), WAXED_EXPOSED_COPPER_BRICK_SLAB.get(), WAXED_WEATHERED_COPPER_BRICK_SLAB.get(), WAXED_OXIDIZED_COPPER_BRICK_SLAB.get(), CASSITERITE_SLAB.get(), POLISHED_CASSITERITE_SLAB.get(), CASSITERITE_BRICK_SLAB.get(), SMOOTH_CASSITERITE_SLAB.get());
		...
		this.tag(BlockTags.STAIRS).add(COBBLESTONE_BRICK_STAIRS.get(), COBBLESTONE_TILE_STAIRS.get(), MOSSY_COBBLESTONE_BRICK_STAIRS.get(), MOSSY_COBBLESTONE_TILE_STAIRS.get(), COBBLED_DEEPSLATE_BRICK_STAIRS.get(), COBBLED_DEEPSLATE_TILE_STAIRS.get(), SPINEL_BRICK_STAIRS.get(), LAPIS_LAZULI_BRICK_STAIRS.get(), TURQUOISE_TILE_STAIRS.get(), SANGUINE_TILE_STAIRS.get(), FORTIFIED_SANGUINE_TILE_STAIRS.get(), DRIPSTONE_SHINGLE_STAIRS.get(), CALCITE_STAIRS.get(), POLISHED_CALCITE_STAIRS.get(), TUFF_STAIRS.get(), POLISHED_TUFF_STAIRS.get(), SUGILITE_STAIRS.get(), POLISHED_SUGILITE_STAIRS.get(), CUT_AMETHYST_BRICK_STAIRS.get(), IRON_BRICK_STAIRS.get(), TIN_BRICK_STAIRS.get(), GOLD_BRICK_STAIRS.get(), SILVER_BRICK_STAIRS.get(), COPPER_BRICK_STAIRS.get(), EXPOSED_COPPER_BRICK_STAIRS.get(), WEATHERED_COPPER_BRICK_STAIRS.get(), OXIDIZED_COPPER_BRICK_STAIRS.get(), WAXED_COPPER_BRICK_STAIRS.get(), WAXED_EXPOSED_COPPER_BRICK_STAIRS.get(), WAXED_WEATHERED_COPPER_BRICK_STAIRS.get(), WAXED_OXIDIZED_COPPER_BRICK_STAIRS.get(), CASSITERITE_STAIRS.get(), POLISHED_CASSITERITE_STAIRS.get(), CASSITERITE_BRICK_STAIRS.get(), SMOOTH_CASSITERITE_STAIRS.get());
		this.tag(BlockTags.WALL_POST_OVERRIDE).add(CUPRIC_TORCH.get());
		this.tag(BlockTags.WALLS).add(COBBLESTONE_BRICK_WALL.get(), COBBLESTONE_TILE_WALL.get(), MOSSY_COBBLESTONE_BRICK_WALL.get(), MOSSY_COBBLESTONE_TILE_WALL.get(), COBBLED_DEEPSLATE_BRICK_WALL.get(), COBBLED_DEEPSLATE_TILE_WALL.get(), SPINEL_BRICK_WALL.get(), LAPIS_LAZULI_BRICK_WALL.get(), TURQUOISE_TILE_WALL.get(), SANGUINE_TILE_WALL.get(), FORTIFIED_SANGUINE_TILE_WALL.get(), DRIPSTONE_SHINGLE_WALL.get(), CALCITE_WALL.get(), TUFF_WALL.get(), SUGILITE_WALL.get(), CUT_AMETHYST_BRICK_WALL.get(), IRON_BRICK_WALL.get(), TIN_BRICK_WALL.get(), GOLD_BRICK_WALL.get(), SILVER_BRICK_WALL.get(), COPPER_BRICK_WALL.get(), EXPOSED_COPPER_BRICK_WALL.get(), WEATHERED_COPPER_BRICK_WALL.get(), OXIDIZED_COPPER_BRICK_WALL.get(), WAXED_COPPER_BRICK_WALL.get(), WAXED_EXPOSED_COPPER_BRICK_WALL.get(), WAXED_WEATHERED_COPPER_BRICK_WALL.get(), WAXED_OXIDIZED_COPPER_BRICK_WALL.get(), CASSITERITE_WALL.get(), CASSITERITE_BRICK_WALL.get());
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				IRON_INGOT.get(), COPPER_INGOT.get(), GOLD_INGOT.get(), NETHERITE_INGOT.get(), SILVER_INGOT.get(), TIN_INGOT.get(), NECROMIUM_INGOT.get()
		);
		...
		this.tag(BlockTags.NEEDS_STONE_TOOL).add(
				...
				EXPOSED_LIGHTNING_ROD.get(), WEATHERED_LIGHTNING_ROD.get(), OXIDIZED_LIGHTNING_ROD.get(), WAXED_LIGHTNING_ROD.get(), WAXED_EXPOSED_LIGHTNING_ROD.get(), WAXED_WEATHERED_LIGHTNING_ROD.get(), WAXED_OXIDIZED_LIGHTNING_ROD.get(),
				SANGUINE_BLOCK.get(), SANGUINE_TILES.get(), SANGUINE_TILE_STAIRS.get(), SANGUINE_TILE_SLAB.get(), SANGUINE_TILE_WALL.get(), FORTIFIED_SANGUINE_TILES.get(), FORTIFIED_SANGUINE_TILE_STAIRS.get(), FORTIFIED_SANGUINE_TILE_SLAB.get(), FORTIFIED_SANGUINE_TILE_WALL.get(),
				COPPER_INGOT.get(), IRON_INGOT.get()
		);
		...
		this.tag(BlockTags.NEEDS_DIAMOND_TOOL).add(TIN_BLOCK.get(), TIN_INGOT.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), CASSITERITE_TIN_ORE.get(), TIN_BARS.get(), HOLD_PLATE.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), STORAGE_DUCT.get(), SCATTERER.get(), SPLURTER.get(), ROLLER_DOOR.get(), ROLLER_DOOR_HEADER.get(), NECROMIUM_BLOCK.get(), NECROMIUM_INGOT.get(), NETHERITE_INGOT.get());
		...
		this.tag(CCBlockTags.DEFLECTS_PROJECTILES).add(TIN_BLOCK.get(), TIN_INGOT.get(), RAW_TIN_BLOCK.get(), TIN_ORE.get(), DEEPSLATE_TIN_ORE.get(), CASSITERITE_TIN_ORE.get(), TIN_BARS.get(), TIN_BRICKS.get(), TIN_BRICK_STAIRS.get(), TIN_BRICK_SLAB.get(), TIN_BRICK_WALL.get(), CHISELED_TIN_BRICKS.get(), FLOAT_GLASS.get(), FLOAT_GLASS_PANE.get(), HOLD_PLATE.get(), HOLD_BUTTON.get(), DIMMER.get(), WALL_DIMMER.get(), HOOP.get(), SPLURTER.get(), SCATTERER.get(), STORAGE_DUCT.get(), ROLLER_DOOR.get(), ROLLER_DOOR_HEADER.get()).addTag(CCBlockTags.WEAKER_DEFLECT_VELOCITY).addTag(CCBlockTags.MAINTAINS_DEFLECT_VELOCITY);
