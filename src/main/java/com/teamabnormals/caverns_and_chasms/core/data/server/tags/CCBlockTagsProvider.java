...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
				...
				SHALE.get(), SHALE_STAIRS.get(), SHALE_SLAB.get(), SHALE_WALL.get(),SMOOTH_SHALE.get(), SMOOTH_SHALE_STAIRS.get(), SMOOTH_SHALE_SLAB.get(), SMOOTH_SHALE_WALL.get(), SHALE_PILLAR.get(),
