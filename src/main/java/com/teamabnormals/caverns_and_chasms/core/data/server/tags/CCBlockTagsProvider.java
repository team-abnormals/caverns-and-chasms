...
public class CCBlockTagsProvider extends BlockTagsProvider {
	...
	public void addTags(Provider provider) {
		...
		this.tag(CCBlockTags.CYLINDRITE_BLOCKS).add(CYLINDRITE.get(), CYLINDRITE_STAIRS.get(), CYLINDRITE_SLAB.get(), CYLINDRITE_WALL.get(), SMOOTH_CYLINDRITE.get(), SMOOTH_CYLINDRITE_STAIRS.get(), SMOOTH_CYLINDRITE_SLAB.get(), SMOOTH_CYLINDRITE_WALL.get());
		this.tag(CCBlockTags.CYLINDRITE_POLISHED_BLOCKS).add(POLISHED_CYLINDRITE.get(), POLISHED_CYLINDRITE_STAIRS.get(), POLISHED_CYLINDRITE_SLAB.get(), POLISHED_CYLINDRITE_WALL.get());
		this.tag(CCBlockTags.CYLINDRITE_BRICK_BLOCKS).add(CYLINDRITE_BRICKS.get(), CYLINDRITE_BRICK_STAIRS.get(), CYLINDRITE_BRICK_SLAB.get(), CYLINDRITE_BRICK_WALL.get(), CYLINDRITE_PILLAR.get(), CHISELED_CYLINDRITE_BRICKS.get());
		this.tag(CCBlockTags.CASSITERITE_BLOCKS).add(CASSITERITE.get(), CASSITERITE_STAIRS.get(), CASSITERITE_SLAB.get(), CASSITERITE_WALL.get(), SMOOTH_CASSITERITE.get(), SMOOTH_CASSITERITE_STAIRS.get(), SMOOTH_CASSITERITE_SLAB.get(), SMOOTH_CASSITERITE_WALL.get());
		this.tag(CCBlockTags.CASSITERITE_POLISHED_BLOCKS).add(CASSITERITE_BRICKS.get(), CASSITERITE_BRICK_STAIRS.get(), CASSITERITE_BRICK_SLAB.get(), CASSITERITE_BRICK_WALL.get(), CASSITERITE_PILLAR.get(), CHISELED_CASSITERITE_BRICKS.get());
		this.tag(CCBlockTags.CASSITERITE_BRICK_BLOCKS).add(POLISHED_CASSITERITE.get(), POLISHED_CASSITERITE_STAIRS.get(), POLISHED_CASSITERITE_SLAB.get(), POLISHED_CASSITERITE_WALL.get());
