...
public class CCTiers {
	...
	public static class CCArmorMaterials {
		public static final ArmorMaterial COPPER = new BlueprintArmorMaterial(new ResourceLocation(CavernsAndChasms.MOD_ID, "copper"), 11, new int[]{1, 3, 4, 2}, 8, () -> SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> Ingredient.of(Tags.Items.INGOTS_COPPER));
