...
public class CCDamageSources {
	public static final DamageSource SPIKED_RAIL = new DamageSource(CavernsAndChasms.MOD_ID + ".spiked_rail").setMagic();
	...
	public static DamageSource causeKunaiDamage(Kunai kunai, @Nullable Entity indirectEntity) {
		return (new IndirectEntityDamageSource(CavernsAndChasms.MOD_ID + ".kunai", kunai, indirectEntity)).setProjectile().setMagic();
	}
}
