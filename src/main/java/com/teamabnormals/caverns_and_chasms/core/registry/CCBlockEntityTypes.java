...
public class CCBlockEntityTypes {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LiftPlateBlockEntity>> LIFT_PLATE = HELPER.createBlockEntity("lift_plate", LiftPlateBlockEntity::new, () -> Set.of(CCBlocks.LIFT_PRESSURE_PLATE.get(), CCBlocks.EXPOSED_LIFT_PRESSURE_PLATE.get(), CCBlocks.WEATHERED_LIFT_PRESSURE_PLATE.get(), CCBlocks.OXIDIZED_LIFT_PRESSURE_PLATE.get(), CCBlocks.WAXED_LIFT_PRESSURE_PLATE.get(), CCBlocks.WAXED_EXPOSED_LIFT_PRESSURE_PLATE.get(), CCBlocks.WAXED_WEATHERED_LIFT_PRESSURE_PLATE.get(), CCBlocks.WAXED_OXIDIZED_LIFT_PRESSURE_PLATE.get()));
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<LiftButtonBlockEntity>> LIFT_BUTTON = HELPER.createBlockEntity("lift_button", LiftButtonBlockEntity::new, () -> Set.of(CCBlocks.LIFT_BUTTON.get(), CCBlocks.EXPOSED_LIFT_BUTTON.get(), CCBlocks.WEATHERED_LIFT_BUTTON.get(), CCBlocks.OXIDIZED_LIFT_BUTTON.get(), CCBlocks.WAXED_LIFT_BUTTON.get(), CCBlocks.WAXED_EXPOSED_LIFT_BUTTON.get(), CCBlocks.WAXED_WEATHERED_LIFT_BUTTON.get(), CCBlocks.WAXED_OXIDIZED_LIFT_BUTTON.get()));
