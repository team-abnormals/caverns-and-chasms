...
public class CCBlockEntityTypes {
	...
	public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<HoldPlateBlockEntity>> HOLD_PLATE = HELPER.createBlockEntity("hold_plate", HoldPlateBlockEntity::new, () -> Set.of(CCBlocks.HOLD_PLATE.get()));
