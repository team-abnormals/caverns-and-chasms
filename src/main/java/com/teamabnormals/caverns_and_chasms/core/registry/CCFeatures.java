...
public class CCFeatures {
	...
	public static final class CCConfiguredFeatures {
		...
		public static final ConfiguredFeature<?, ?> ORE_FRAGILE_STONE = register("ore_fragile_stone", Feature.ORE.configured(new OreConfiguration(ORE_FRAGILE_STONE_TARGET_LIST, 48, 0.2F)));
	...
	public static final class CCPlacedFeatures {
		...
		public static final PlacedFeature ORE_FRAGILE_STONE = register("ore_fragile_stone", CCConfiguredFeatures.ORE_FRAGILE_STONE.placed(commonOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(64)))));
