...
public class CCSoundEvents {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> SCHIST_BRICKS_PLACE = SOUNDS.createSoundEvent("block.schist_bricks.place");
	public static final DeferredHolder<SoundEvent, SoundEvent> SCHIST_BRICKS_STEP = SOUNDS.createSoundEvent("block.schist_bricks.step");
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> CASSITERITE_BRICKS_PLACE = SOUNDS.createSoundEvent("block.cassiterite_bricks.place");
	public static final DeferredHolder<SoundEvent, SoundEvent> CASSITERITE_BRICKS_STEP = SOUNDS.createSoundEvent("block.cassiterite_bricks.step");
	public static final DeferredHolder<SoundEvent, SoundEvent> CASSITERITE_BRICKS_DEFLECT = SOUNDS.createSoundEvent("block.cassiterite_bricks.deflect");
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> SILVER_CHAIN_PLACE = SOUNDS.createSoundEvent("block.silver_chain.place");
	public static final DeferredHolder<SoundEvent, SoundEvent> SILVER_CHAIN_HIT = SOUNDS.createSoundEvent("block.silver_chain.hit");
	public static final DeferredHolder<SoundEvent, SoundEvent> SILVER_CHAIN_FALL = SOUNDS.createSoundEvent("block.silver_chain.fall");
	...
	public static class CCSoundTypes {
		...
		public static final DeferredSoundType SCHIST = new DeferredSoundType(1.0F, 1.0F, SCHIST_BREAK, SCHIST_STEP, SCHIST_PLACE, SCHIST_HIT, SCHIST_FALL);
		public static final DeferredSoundType POLISHED_SCHIST = new DeferredSoundType(1.0F, 1.0F, POLISHED_SCHIST_BREAK, POLISHED_SCHIST_STEP, POLISHED_SCHIST_PLACE, POLISHED_SCHIST_HIT, POLISHED_SCHIST_FALL);
		public static final DeferredSoundType SCHIST_BRICKS = new DeferredSoundType(1.0F, 1.0F, SCHIST_BRICKS_BREAK, SCHIST_BRICKS_STEP, SCHIST_BRICKS_PLACE, SCHIST_BRICKS_HIT, SCHIST_BRICKS_FALL);
		...
		public static final DeferredSoundType CASSITERITE = new DeferredSoundType(1.0F, 1.0F, CASSITERITE_BREAK, CASSITERITE_STEP, CASSITERITE_PLACE, CASSITERITE_HIT, CASSITERITE_FALL);
		public static final DeferredSoundType CASSITERITE_BRICKS = new DeferredSoundType(1.0F, 1.0F, CASSITERITE_BRICKS_BREAK, CASSITERITE_BRICKS_STEP, CASSITERITE_BRICKS_PLACE, CASSITERITE_BRICKS_HIT, CASSITERITE_BRICKS_FALL);
		public static final DeferredSoundType POLISHED_CASSITERITE = new DeferredSoundType(1.0F, 1.0F, POLISHED_CASSITERITE_BREAK, POLISHED_CASSITERITE_STEP, POLISHED_CASSITERITE_PLACE, POLISHED_CASSITERITE_HIT, POLISHED_CASSITERITE_FALL);
		public static final DeferredSoundType CYLINDRITE = new DeferredSoundType(1.0F, 1.0F, CYLINDRITE_BREAK, CYLINDRITE_STEP, CYLINDRITE_PLACE, CYLINDRITE_HIT, CYLINDRITE_FALL);
		public static final DeferredSoundType CYLINDRITE_BRICKS = new DeferredSoundType(1.0F, 1.0F, CYLINDRITE_BRICKS_BREAK, CYLINDRITE_BRICKS_STEP, CYLINDRITE_BRICKS_PLACE, CYLINDRITE_BRICKS_HIT, CYLINDRITE_BRICKS_FALL);
		public static final DeferredSoundType POLISHED_CYLINDRITE = new DeferredSoundType(1.0F, 1.0F, POLISHED_CYLINDRITE_BREAK, POLISHED_CYLINDRITE_STEP, POLISHED_CYLINDRITE_PLACE, POLISHED_CYLINDRITE_HIT, POLISHED_CYLINDRITE_FALL);
		...
		public static final DeferredSoundType FLOAT_GLASS = new DeferredSoundType(1.0F, 1.0F, FLOAT_GLASS_BREAK, FLOAT_GLASS_STEP, FLOAT_GLASS_PLACE, FLOAT_GLASS_HIT, FLOAT_GLASS_FALL);
		...
		public static final DeferredSoundType TINPLATE = new DeferredSoundType(1.0F, 1.0F, TINPLATE_BREAK, TINPLATE_STEP, TINPLATE_PLACE, TINPLATE_HIT, TINPLATE_FALL);
		public static final DeferredSoundType DIMMER = new DeferredSoundType(1.0F, 1.0F, DIMMER_BREAK, DIMMER_STEP, DIMMER_PLACE, DIMMER_HIT, DIMMER_FALL);
		public static final DeferredSoundType REFRACTOR = new DeferredSoundType(1.0F, 1.0F, REFRACTOR_BREAK, REFRACTOR_STEP, REFRACTOR_PLACE, REFRACTOR_HIT, REFRACTOR_FALL);
		public static final DeferredSoundType BOUNCER = new DeferredSoundType(1.0F, 1.0F, BOUNCER_BREAK, BOUNCER_STEP, BOUNCER_PLACE, BOUNCER_HIT, BOUNCER_FALL);
		public static final DeferredSoundType SADDLED_EGG = new DeferredSoundType(1.0F, 1.0F, SADDLED_EGG_BREAK, SADDLED_EGG_STEP, SADDLED_EGG_PLACE, SADDLED_EGG_HIT, SADDLED_EGG_FALL);
		public static final DeferredSoundType TIN_BULB = new DeferredSoundType(1.0F, 1.0F, TIN_BULB_BREAK, TIN_BULB_STEP, TIN_BULB_PLACE, TIN_BULB_HIT, TIN_BULB_FALL);
		public static final DeferredSoundType TIN_CHAIN = new DeferredSoundType(1.0F, 1.0F, TIN_CHAIN_BREAK, TIN_CHAIN_STEP, TIN_CHAIN_PLACE, TIN_CHAIN_HIT, TIN_CHAIN_FALL);
		public static final DeferredSoundType TIN_ORE = new DeferredSoundType(1.0F, 1.0F, TIN_ORE_BREAK, TIN_ORE_STEP, TIN_ORE_PLACE, TIN_ORE_HIT, TIN_ORE_FALL);
		public static final DeferredSoundType DEEPSLATE_TIN_ORE = new DeferredSoundType(1.0F, 1.0F, DEEPSLATE_TIN_ORE_BREAK, DEEPSLATE_TIN_ORE_STEP, DEEPSLATE_TIN_ORE_PLACE, DEEPSLATE_TIN_ORE_HIT, DEEPSLATE_TIN_ORE_FALL);
		public static final DeferredSoundType CYLINDRITE_TIN_ORE = new DeferredSoundType(1.0F, 1.0F, CYLINDRITE_TIN_ORE_BREAK, CYLINDRITE_TIN_ORE_STEP, CYLINDRITE_TIN_ORE_PLACE, CYLINDRITE_TIN_ORE_HIT, CYLINDRITE_TIN_ORE_FALL);
		public static final DeferredSoundType CASSITERITE_TIN_ORE = new DeferredSoundType(1.0F, 1.0F, CASSITERITE_TIN_ORE_BREAK, CASSITERITE_TIN_ORE_STEP, CASSITERITE_TIN_ORE_PLACE, CASSITERITE_TIN_ORE_HIT, CASSITERITE_TIN_ORE_FALL);
		public static final DeferredSoundType STORAGE_DUCT = new DeferredSoundType(1.0F, 1.0F, STORAGE_DUCT_BREAK, STORAGE_DUCT_STEP, STORAGE_DUCT_PLACE, STORAGE_DUCT_HIT, STORAGE_DUCT_FALL);
		public static final DeferredSoundType ROLLER_DOOR = new DeferredSoundType(1.0F, 1.0F, ROLLER_DOOR_BREAK, ROLLER_DOOR_STEP, ROLLER_DOOR_PLACE, ROLLER_DOOR_HIT, ROLLER_DOOR_FALL);
