...
public class CCSoundEvents {
	...
	public static class CCSoundTypes {
		...
		public static final ForgeSoundType FLOAT_GLASS = new ForgeSoundType(1.0F, 1.0F, FLOAT_GLASS_BREAK, FLOAT_GLASS_STEP, FLOAT_GLASS_PLACE, FLOAT_GLASS_HIT, FLOAT_GLASS_FALL);
