...
public class CCItems {
	...
	public static final DeferredItem<Item> COPPER_HELMET = HELPER.createItem("copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.UNAFFECTED, CCArmorMaterials.COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> COPPER_CHESTPLATE = HELPER.createItem("copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.UNAFFECTED, CCArmorMaterials.COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> COPPER_LEGGINGS = HELPER.createItem("copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.UNAFFECTED, CCArmorMaterials.COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> COPPER_BOOTS = HELPER.createItem("copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.UNAFFECTED, CCArmorMaterials.COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	...
	public static final DeferredItem<Item> EXPOSED_COPPER_HELMET = HELPER.createItem("exposed_copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.EXPOSED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> EXPOSED_COPPER_CHESTPLATE = HELPER.createItem("exposed_copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.EXPOSED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> EXPOSED_COPPER_LEGGINGS = HELPER.createItem("exposed_copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.EXPOSED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> EXPOSED_COPPER_BOOTS = HELPER.createItem("exposed_copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.EXPOSED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	public static final DeferredItem<Item> EXPOSED_COPPER_SWORD = HELPER.createItem("exposed_copper_sword", () -> new WeatheringSwordItem(WeatherState.EXPOSED, CCItemTiers.COPPER, new Item.Properties().attributes(SwordItem.createAttributes(CCItemTiers.COPPER, 3, -2.4F))));
	public static final DeferredItem<Item> EXPOSED_COPPER_SHOVEL = HELPER.createItem("exposed_copper_shovel", () -> new WeatheringShovelItem(WeatherState.EXPOSED, CCItemTiers.COPPER, new Item.Properties().attributes(ShovelItem.createAttributes(CCItemTiers.COPPER, 1.5F, -3.0F))));
	public static final DeferredItem<Item> EXPOSED_COPPER_PICKAXE = HELPER.createItem("exposed_copper_pickaxe", () -> new WeatheringPickaxeItem(WeatherState.EXPOSED, CCItemTiers.COPPER, new Item.Properties().attributes(PickaxeItem.createAttributes(CCItemTiers.COPPER, 1, -2.8F))));
	public static final DeferredItem<Item> EXPOSED_COPPER_AXE = HELPER.createItem("exposed_copper_axe", () -> new WeatheringAxeItem(WeatherState.EXPOSED, CCItemTiers.COPPER, new Item.Properties().attributes(AxeItem.createAttributes(CCItemTiers.COPPER, 7.0F, -3.2F))));
	public static final DeferredItem<Item> EXPOSED_COPPER_HOE = HELPER.createItem("exposed_copper_hoe", () -> new WeatheringHoeItem(WeatherState.EXPOSED, CCItemTiers.COPPER, new Item.Properties().attributes(HoeItem.createAttributes(CCItemTiers.COPPER, -1.0F, -2.0F))));
	...
	public static final DeferredItem<Item> WEATHERED_COPPER_HELMET = HELPER.createItem("weathered_copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.WEATHERED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WEATHERED_COPPER_CHESTPLATE = HELPER.createItem("weathered_copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.WEATHERED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WEATHERED_COPPER_LEGGINGS = HELPER.createItem("weathered_copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.WEATHERED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WEATHERED_COPPER_BOOTS = HELPER.createItem("weathered_copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.WEATHERED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	public static final DeferredItem<Item> WEATHERED_COPPER_SWORD = HELPER.createItem("weathered_copper_sword", () -> new WeatheringSwordItem(WeatherState.WEATHERED, CCItemTiers.COPPER, new Item.Properties().attributes(SwordItem.createAttributes(CCItemTiers.COPPER, 3, -2.4F))));
	public static final DeferredItem<Item> WEATHERED_COPPER_SHOVEL = HELPER.createItem("weathered_copper_shovel", () -> new WeatheringShovelItem(WeatherState.WEATHERED, CCItemTiers.COPPER, new Item.Properties().attributes(ShovelItem.createAttributes(CCItemTiers.COPPER, 1.5F, -3.0F))));
	public static final DeferredItem<Item> WEATHERED_COPPER_PICKAXE = HELPER.createItem("weathered_copper_pickaxe", () -> new WeatheringPickaxeItem(WeatherState.WEATHERED, CCItemTiers.COPPER, new Item.Properties().attributes(PickaxeItem.createAttributes(CCItemTiers.COPPER, 1, -2.8F))));
	public static final DeferredItem<Item> WEATHERED_COPPER_AXE = HELPER.createItem("weathered_copper_axe", () -> new WeatheringAxeItem(WeatherState.WEATHERED, CCItemTiers.COPPER, new Item.Properties().attributes(AxeItem.createAttributes(CCItemTiers.COPPER, 7.0F, -3.2F))));
	public static final DeferredItem<Item> WEATHERED_COPPER_HOE = HELPER.createItem("weathered_copper_hoe", () -> new WeatheringHoeItem(WeatherState.WEATHERED, CCItemTiers.COPPER, new Item.Properties().attributes(HoeItem.createAttributes(CCItemTiers.COPPER, -1.0F, -2.0F))));
	...
	public static final DeferredItem<Item> OXIDIZED_COPPER_HELMET = HELPER.createItem("oxidized_copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.OXIDIZED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_CHESTPLATE = HELPER.createItem("oxidized_copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.OXIDIZED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_LEGGINGS = HELPER.createItem("oxidized_copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.OXIDIZED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_BOOTS = HELPER.createItem("oxidized_copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.OXIDIZED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_SWORD = HELPER.createItem("oxidized_copper_sword", () -> new WeatheringSwordItem(WeatherState.OXIDIZED, CCItemTiers.COPPER, new Item.Properties().attributes(SwordItem.createAttributes(CCItemTiers.COPPER, 3, -2.4F))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_SHOVEL = HELPER.createItem("oxidized_copper_shovel", () -> new WeatheringShovelItem(WeatherState.OXIDIZED, CCItemTiers.COPPER, new Item.Properties().attributes(ShovelItem.createAttributes(CCItemTiers.COPPER, 1.5F, -3.0F))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_PICKAXE = HELPER.createItem("oxidized_copper_pickaxe", () -> new WeatheringPickaxeItem(WeatherState.OXIDIZED, CCItemTiers.COPPER, new Item.Properties().attributes(PickaxeItem.createAttributes(CCItemTiers.COPPER, 1, -2.8F))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_AXE = HELPER.createItem("oxidized_copper_axe", () -> new WeatheringAxeItem(WeatherState.OXIDIZED, CCItemTiers.COPPER, new Item.Properties().attributes(AxeItem.createAttributes(CCItemTiers.COPPER, 7.0F, -3.2F))));
	public static final DeferredItem<Item> OXIDIZED_COPPER_HOE = HELPER.createItem("oxidized_copper_hoe", () -> new WeatheringHoeItem(WeatherState.OXIDIZED, CCItemTiers.COPPER, new Item.Properties().attributes(HoeItem.createAttributes(CCItemTiers.COPPER, -1.0F, -2.0F))));
	...
	public static final DeferredItem<Item> WAXED_COPPER_HELMET = HELPER.createItem("waxed_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_COPPER_CHESTPLATE = HELPER.createItem("waxed_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_COPPER_LEGGINGS = HELPER.createItem("waxed_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_COPPER_BOOTS = HELPER.createItem("waxed_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	...
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_HELMET = HELPER.createItem("waxed_exposed_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.EXPOSED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_CHESTPLATE = HELPER.createItem("waxed_exposed_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.EXPOSED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_LEGGINGS = HELPER.createItem("waxed_exposed_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.EXPOSED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_BOOTS = HELPER.createItem("waxed_exposed_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.EXPOSED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_SWORD = HELPER.createItem("waxed_exposed_copper_sword", () -> new SwordItem(CCItemTiers.COPPER, new Item.Properties().attributes(SwordItem.createAttributes(CCItemTiers.COPPER, 3, -2.4F))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_SHOVEL = HELPER.createItem("waxed_exposed_copper_shovel", () -> new ShovelItem(CCItemTiers.COPPER, new Item.Properties().attributes(ShovelItem.createAttributes(CCItemTiers.COPPER, 1.5F, -3.0F))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_PICKAXE = HELPER.createItem("waxed_exposed_copper_pickaxe", () -> new PickaxeItem(CCItemTiers.COPPER, new Item.Properties().attributes(PickaxeItem.createAttributes(CCItemTiers.COPPER, 1, -2.8F))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_AXE = HELPER.createItem("waxed_exposed_copper_axe", () -> new AxeItem(CCItemTiers.COPPER, new Item.Properties().attributes(AxeItem.createAttributes(CCItemTiers.COPPER, 7.0F, -3.2F))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_HOE = HELPER.createItem("waxed_exposed_copper_hoe", () -> new HoeItem(CCItemTiers.COPPER, new Item.Properties().attributes(HoeItem.createAttributes(CCItemTiers.COPPER, -1.0F, -2.0F))));
	...
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_HELMET = HELPER.createItem("waxed_weathered_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.WEATHERED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_CHESTPLATE = HELPER.createItem("waxed_weathered_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.WEATHERED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_LEGGINGS = HELPER.createItem("waxed_weathered_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.WEATHERED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_BOOTS = HELPER.createItem("waxed_weathered_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.WEATHERED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_SWORD = HELPER.createItem("waxed_weathered_copper_sword", () -> new SwordItem(CCItemTiers.COPPER, new Item.Properties().attributes(SwordItem.createAttributes(CCItemTiers.COPPER, 3, -2.4F))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_SHOVEL = HELPER.createItem("waxed_weathered_copper_shovel", () -> new ShovelItem(CCItemTiers.COPPER, new Item.Properties().attributes(ShovelItem.createAttributes(CCItemTiers.COPPER, 1.5F, -3.0F))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_PICKAXE = HELPER.createItem("waxed_weathered_copper_pickaxe", () -> new PickaxeItem(CCItemTiers.COPPER, new Item.Properties().attributes(PickaxeItem.createAttributes(CCItemTiers.COPPER, 1, -2.8F))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_AXE = HELPER.createItem("waxed_weathered_copper_axe", () -> new AxeItem(CCItemTiers.COPPER, new Item.Properties().attributes(AxeItem.createAttributes(CCItemTiers.COPPER, 7.0F, -3.2F))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_HOE = HELPER.createItem("waxed_weathered_copper_hoe", () -> new HoeItem(CCItemTiers.COPPER, new Item.Properties().attributes(HoeItem.createAttributes(CCItemTiers.COPPER, -1.0F, -2.0F))));
	...
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_HELMET = HELPER.createItem("waxed_oxidized_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.OXIDIZED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_CHESTPLATE = HELPER.createItem("waxed_oxidized_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.OXIDIZED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_LEGGINGS = HELPER.createItem("waxed_oxidized_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.OXIDIZED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_BOOTS = HELPER.createItem("waxed_oxidized_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.OXIDIZED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_SWORD = HELPER.createItem("waxed_oxidized_copper_sword", () -> new SwordItem(CCItemTiers.COPPER, new Item.Properties().attributes(SwordItem.createAttributes(CCItemTiers.COPPER, 3, -2.4F))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_SHOVEL = HELPER.createItem("waxed_oxidized_copper_shovel", () -> new ShovelItem(CCItemTiers.COPPER, new Item.Properties().attributes(ShovelItem.createAttributes(CCItemTiers.COPPER, 1.5F, -3.0F))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_PICKAXE = HELPER.createItem("waxed_oxidized_copper_pickaxe", () -> new PickaxeItem(CCItemTiers.COPPER, new Item.Properties().attributes(PickaxeItem.createAttributes(CCItemTiers.COPPER, 1, -2.8F))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_AXE = HELPER.createItem("waxed_oxidized_copper_axe", () -> new AxeItem(CCItemTiers.COPPER, new Item.Properties().attributes(AxeItem.createAttributes(CCItemTiers.COPPER, 7.0F, -3.2F))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_HOE = HELPER.createItem("waxed_oxidized_copper_hoe", () -> new HoeItem(CCItemTiers.COPPER, new Item.Properties().attributes(HoeItem.createAttributes(CCItemTiers.COPPER, -1.0F, -2.0F))));
	...
	public static final DeferredItem<Item> SILVER_HELMET = HELPER.createItem("silver_helmet", () -> new SilverArmorItem(CCArmorMaterials.SILVER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(11))));
	public static final DeferredItem<Item> SILVER_CHESTPLATE = HELPER.createItem("silver_chestplate", () -> new SilverArmorItem(CCArmorMaterials.SILVER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(11))));
	public static final DeferredItem<Item> SILVER_LEGGINGS = HELPER.createItem("silver_leggings", () -> new SilverArmorItem(CCArmorMaterials.SILVER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(11))));
	public static final DeferredItem<Item> SILVER_BOOTS = HELPER.createItem("silver_boots", () -> new SilverArmorItem(CCArmorMaterials.SILVER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(11))));
	...
	public static final DeferredItem<Item> NECROMIUM_HELMET = HELPER.createItem("necromium_helmet", () -> new NecromiumArmorItem(CCArmorMaterials.NECROMIUM, Type.HELMET, new Item.Properties().fireResistant().durability(Type.HELMET.getDurability(37))));
	public static final DeferredItem<Item> NECROMIUM_CHESTPLATE = HELPER.createItem("necromium_chestplate", () -> new NecromiumArmorItem(CCArmorMaterials.NECROMIUM, Type.CHESTPLATE, new Item.Properties().fireResistant().durability(Type.CHESTPLATE.getDurability(37))));
	public static final DeferredItem<Item> NECROMIUM_LEGGINGS = HELPER.createItem("necromium_leggings", () -> new NecromiumArmorItem(CCArmorMaterials.NECROMIUM, Type.LEGGINGS, new Item.Properties().fireResistant().durability(Type.LEGGINGS.getDurability(37))));
	public static final DeferredItem<Item> NECROMIUM_BOOTS = HELPER.createItem("necromium_boots", () -> new NecromiumArmorItem(CCArmorMaterials.NECROMIUM, Type.BOOTS, new Item.Properties().fireResistant().durability(Type.BOOTS.getDurability(37))));
	...
	public static final DeferredItem<Item> SANGUINE_HELMET = HELPER.createItem("sanguine_helmet", () -> new SanguineArmorItem(CCArmorMaterials.SANGUINE, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(23))));
	public static final DeferredItem<Item> SANGUINE_CHESTPLATE = HELPER.createItem("sanguine_chestplate", () -> new SanguineArmorItem(CCArmorMaterials.SANGUINE, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(23))));
	public static final DeferredItem<Item> SANGUINE_LEGGINGS = HELPER.createItem("sanguine_leggings", () -> new SanguineArmorItem(CCArmorMaterials.SANGUINE, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(23))));
	public static final DeferredItem<Item> SANGUINE_BOOTS = HELPER.createItem("sanguine_boots", () -> new SanguineArmorItem(CCArmorMaterials.SANGUINE, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(23))));
	...
	public static final DeferredItem<Item> PACKING_CONTAINER = HELPER.createItem("packing_container", () -> new PackingContainerItem(new Item.Properties().stacksTo(1).component(CCDataComponents.PACKING_CONTAINER_CONTENTS, PackingContainerContents.EMPTY)));
	...
	public static final DeferredItem<Item> COWL = HELPER.createItem("cowl", () -> new CowlItem(CCArmorMaterials.COWL, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(5))));
	public static final DeferredItem<Item> TOOLBELT = HELPER.createItem("toolbelt", () -> new ToolbeltItem(CCArmorMaterials.TOOLBELT, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(5))));
