...
public class CCItems {
	...
	public static final RegistryObject<Item> EXPOSED_COPPER_HELMET = HELPER.createItem("exposed_copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<Item> EXPOSED_COPPER_CHESTPLATE = HELPER.createItem("exposed_copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<Item> EXPOSED_COPPER_LEGGINGS = HELPER.createItem("exposed_copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> EXPOSED_COPPER_BOOTS = HELPER.createItem("exposed_copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.EXPOSED, CCArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties()));
	...
	public static final RegistryObject<Item> WEATHERED_COPPER_HELMET = HELPER.createItem("weathered_copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<Item> WEATHERED_COPPER_CHESTPLATE = HELPER.createItem("weathered_copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<Item> WEATHERED_COPPER_LEGGINGS = HELPER.createItem("weathered_copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> WEATHERED_COPPER_BOOTS = HELPER.createItem("weathered_copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.WEATHERED, CCArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties()));
	...
	public static final RegistryObject<Item> OXIDIZED_COPPER_HELMET = HELPER.createItem("oxidized_copper_helmet", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<Item> OXIDIZED_COPPER_CHESTPLATE = HELPER.createItem("oxidized_copper_chestplate", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<Item> OXIDIZED_COPPER_LEGGINGS = HELPER.createItem("oxidized_copper_leggings", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> OXIDIZED_COPPER_BOOTS = HELPER.createItem("oxidized_copper_boots", () -> new WeatheringCopperArmorItem(WeatherState.OXIDIZED, CCArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties()));
	...
	public static final RegistryObject<Item> WAXED_EXPOSED_COPPER_HELMET = HELPER.createItem("waxed_exposed_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_EXPOSED_COPPER_CHESTPLATE = HELPER.createItem("waxed_exposed_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_EXPOSED_COPPER_LEGGINGS = HELPER.createItem("waxed_exposed_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_EXPOSED_COPPER_BOOTS = HELPER.createItem("waxed_exposed_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties()));
	...
	public static final RegistryObject<Item> WAXED_WEATHERED_COPPER_HELMET = HELPER.createItem("waxed_weathered_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_WEATHERED_COPPER_CHESTPLATE = HELPER.createItem("waxed_weathered_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_WEATHERED_COPPER_LEGGINGS = HELPER.createItem("waxed_weathered_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_WEATHERED_COPPER_BOOTS = HELPER.createItem("waxed_weathered_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties()));
	...
	public static final RegistryObject<Item> WAXED_OXIDIZED_COPPER_HELMET = HELPER.createItem("waxed_oxidized_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.HELMET, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_OXIDIZED_COPPER_CHESTPLATE = HELPER.createItem("waxed_oxidized_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_OXIDIZED_COPPER_LEGGINGS = HELPER.createItem("waxed_oxidized_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.LEGGINGS, new Item.Properties()));
	public static final RegistryObject<Item> WAXED_OXIDIZED_COPPER_BOOTS = HELPER.createItem("waxed_oxidized_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.COPPER, ArmorItem.Type.BOOTS, new Item.Properties()));
