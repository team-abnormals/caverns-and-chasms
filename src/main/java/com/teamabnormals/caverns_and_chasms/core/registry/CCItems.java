...
public class CCItems {
	...
	public static final DeferredItem<Item> WAXED_COPPER_HELMET = HELPER.createItem("waxed_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.WAXED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_COPPER_CHESTPLATE = HELPER.createItem("waxed_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.WAXED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_COPPER_LEGGINGS = HELPER.createItem("waxed_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.WAXED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_COPPER_BOOTS = HELPER.createItem("waxed_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.WAXED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	...
	public static final DeferredItem<Item> WAXED_COPPER_HORSE_ARMOR = HELPER.createItem("waxed_copper_horse_armor", () -> new CopperHorseArmorItem(CCArmorMaterials.WAXED_COPPER, new Item.Properties().stacksTo(1)));

	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_HELMET = HELPER.createItem("waxed_exposed_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.WAXED_EXPOSED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_CHESTPLATE = HELPER.createItem("waxed_exposed_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.WAXED_EXPOSED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_LEGGINGS = HELPER.createItem("waxed_exposed_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.WAXED_EXPOSED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_BOOTS = HELPER.createItem("waxed_exposed_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.WAXED_EXPOSED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	...
	public static final DeferredItem<Item> WAXED_EXPOSED_COPPER_HORSE_ARMOR = HELPER.createItem("waxed_exposed_copper_horse_armor", () -> new CopperHorseArmorItem(CCArmorMaterials.WAXED_EXPOSED_COPPER, new Item.Properties().stacksTo(1)));

	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_HELMET = HELPER.createItem("waxed_weathered_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.WAXED_WEATHERED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_CHESTPLATE = HELPER.createItem("waxed_weathered_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.WAXED_WEATHERED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_LEGGINGS = HELPER.createItem("waxed_weathered_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.WAXED_WEATHERED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_BOOTS = HELPER.createItem("waxed_weathered_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.WAXED_WEATHERED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	...
	public static final DeferredItem<Item> WAXED_WEATHERED_COPPER_HORSE_ARMOR = HELPER.createItem("waxed_weathered_copper_horse_armor", () -> new CopperHorseArmorItem(CCArmorMaterials.WAXED_WEATHERED_COPPER, new Item.Properties().stacksTo(1)));

	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_HELMET = HELPER.createItem("waxed_oxidized_copper_helmet", () -> new CopperArmorItem(CCArmorMaterials.WAXED_OXIDIZED_COPPER, Type.HELMET, new Item.Properties().durability(Type.HELMET.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_CHESTPLATE = HELPER.createItem("waxed_oxidized_copper_chestplate", () -> new CopperArmorItem(CCArmorMaterials.WAXED_OXIDIZED_COPPER, Type.CHESTPLATE, new Item.Properties().durability(Type.CHESTPLATE.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_LEGGINGS = HELPER.createItem("waxed_oxidized_copper_leggings", () -> new CopperArmorItem(CCArmorMaterials.WAXED_OXIDIZED_COPPER, Type.LEGGINGS, new Item.Properties().durability(Type.LEGGINGS.getDurability(56))));
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_BOOTS = HELPER.createItem("waxed_oxidized_copper_boots", () -> new CopperArmorItem(CCArmorMaterials.WAXED_OXIDIZED_COPPER, Type.BOOTS, new Item.Properties().durability(Type.BOOTS.getDurability(56))));
	...
	public static final DeferredItem<Item> WAXED_OXIDIZED_COPPER_HORSE_ARMOR = HELPER.createItem("waxed_oxidized_copper_horse_armor", () -> new CopperHorseArmorItem(CCArmorMaterials.WAXED_OXIDIZED_COPPER, new Item.Properties().stacksTo(1)));
