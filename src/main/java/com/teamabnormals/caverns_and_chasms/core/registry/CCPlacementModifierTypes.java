...
public class CCPlacementModifierTypes {
	...
	public static final DeferredHolder<PlacementModifierType<?>, PlacementModifierType<TinMonolithDistanceFilter>> TIN_MONOLITH_DISTANCE_FILTER = PLACEMENT_MODIFIER_TYPES.register("tin_monolith_distance_filter", () -> () -> TinMonolithDistanceFilter.CODEC);
	public static final DeferredHolder<PlacementModifierType<?>, PlacementModifierType<HeightmapRandomOffsetPlacement>> HEIGHTMAP_RANDOM_OFFSET = PLACEMENT_MODIFIER_TYPES.register("heightmap_random_offset", () -> () -> HeightmapRandomOffsetPlacement.CODEC);
